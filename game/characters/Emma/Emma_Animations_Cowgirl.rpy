...
image Emma_Cowgirl_HairBack:
    #Hair underlay
    ConditionSwitch(
            "E_Hair", +str(emma_bj_loc)"/Emma_BJ_Hair_Wave_Back.png",
            "True", Null(),
            ),
    zoom 0.48
    anchor (0.5, 0.5)
...
image Emma_Cowgirl_Tits:
    ...
    contains:
        ...
        ConditionSwitch(
            ...
            "E_Chest == 'corset'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Tits_Up.png",   # E_TitsUp = 1
            "E_Chest == 'sports bra' or E_Chest == 'lace bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Tits_Up.png",   # E_TitsUp = 1
            "True", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Tits_Down.png",   # E_TitsUp = 0
            )
    contains:
            # piercings tits
        ConditionSwitch(
...
#            "E_Over == 'nighty'", Null(),
            "E_Pierce == 'barbell'", ConditionSwitch(
                    ...
                    "True", +str(emma_cowgirl_loc)"/Emma_Pierce_Barbell_Tits_D.png",
                    ),
            "E_Pierce == 'ring'", ConditionSwitch(
                    #if it's the ring pericings
                    "E_Chest in ('corset', 'lace bra', 'sports bra')", Null(),
                    "True", +str(emma_cowgirl_loc)"/Emma_Pierce_Ring_Tits_D.png",
                    ),
            "True", Null(),
            )
...
image Emma_Cowgirl_Torso:
    ...
    contains:
            # body
            +str(emma_cowgirl_loc)"/EmmaCowgirl/Emma_Cowgirl_Body.png"
    contains:
            # tits
        ConditionSwitch(
            "renpy.showing('Emma_TJ_Animation')", Null(),
...
#            )
    contains:
            ...
            ConditionSwitch(
                ...
                "E_Chest == 'sports bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Bra_Sports_TJU.png",
                "True", Null(),
                )
    contains:
        ...
        ConditionSwitch(
            ...
            "E_Chest == 'corset'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Bra_Corset_Up.png",   # E_TitsUp = 1
            "E_Chest == 'sports bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Bra_Sports_Up.png",   # E_TitsUp = 1
            "E_Chest == 'lace bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Bra_Lace_Up.png",   # E_TitsUp = 1
    ...
    contains:
        ...
        ConditionSwitch(
            "E_Over == 'jacket'", ConditionSwitch(
                    #if it's the ring pericings
                    "renpy.showing('Emma_TJ_Animation')", Null(),
#                    "renpy.showing('Emma_TJ_Animation')", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Jacket_Down.png",
                    "E_Chest == 'corset'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Jacket_Up.png",   # E_TitsUp = 1
                    "E_Chest == 'sports bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Jacket_Up.png",   # E_TitsUp = 1
                    "E_Chest == 'lace bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Jacket_Up.png",   # E_TitsUp = 1
                    "True", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Jacket_Down.png",   # E_TitsUp = 0
                    ),
            "True", Null(),
            )
    contains:
            ...
            ConditionSwitch(
                ...
                "renpy.showing('Emma_TJ_Animation')", +str(emma_cowgirl_loc)"/Emma_Spunk_Titjob_Under.png",
                "True", +str(emma_cowgirl_loc)"/Emma_Spunk_Tits.png",
                )
    zoom 1
...
image Emma_Cowgirl_Body:
    ...
    contains:
        ...
        ConditionSwitch(
            ...
            "Emma_Arms == 4", AlphaMask("Emma_Arms", +str(emma_cowgirl_loc)"/Emma_Cowgirl_ArmsMask_R.png"),   # Right arm only
            "Emma_Arms == 5", AlphaMask("Emma_Arms", +str(emma_cowgirl_loc)"/Emma_Cowgirl_ArmsMask_L.png"),   # Left arm only
            "True", AlphaMask("Emma_Arms", +str(emma_cowgirl_loc)"/Emma_Cowgirl_ArmsMask.png"),  # Both Arms
            )
    contains:
            "Emma_Cowgirl_Head"
    zoom 1
...
image Emma_Arms:
    contains:
        ...
        ConditionSwitch(
            "E_Over == 'jacket'", Null(),
            "E_Chest == 'corset'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Arms_U.png",   # E_TitsUp = 1
            "E_Chest == 'sports bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Arms_U.png",   # E_TitsUp = 1
            "E_Chest == 'lace bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Arms_U.png",   # E_TitsUp = 1
            "True", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Arms_D.png",   # E_TitsUp = 0
            )
    contains:
            # Arm clothing
        ConditionSwitch(
            "E_Over == 'jacket'", Null(),
            "E_Chest == 'sports bra'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Bra_Sports_Arms.png",   # E_TitsUp = 1
            "True", Null(),
            )
    contains:
            # Arm clothing Over
        ConditionSwitch(
            "E_Over == 'jacket'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Arms_Jacket.png",   # E_TitsUp = 1
            "E_Arms", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Gloves.png",
            "True", Null(),
            )
...
image Emma_Cowgirl_Legs_S:
    ...
    contains:
            # spunk
        ConditionSwitch(
            "'anal' in E_Spunk or 'in' in E_Spunk", +str(emma_cowgirl_loc)"/Emma_Spunk_Sex.png",
            "True", Null(),
            )
    contains:
            # Legs base
        ConditionSwitch(
            "Trigger == 'hotdog'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Legs_Hotdog.png",
            "True", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Legs_Sex.png",
            )
    contains:
            # piercings
        ConditionSwitch(
            ...
            "E_Pierce == 'barbell'", +str(emma_cowgirl_loc)"/Emma_Pierce_Barbell_Pussy_S.png",
            "E_Pierce == 'ring'", +str(emma_cowgirl_loc)"/Emma_Pierce_Ring_Pussy_S.png",
            "True", Null(),
            )
    contains:
            # pubes
        ConditionSwitch(
            "E_Pubes", +str(emma_cowgirl_loc)"/Emma_Pubes_Sex.png",
            "True", Null(),
            )
    contains:
            # panties
        ConditionSwitch(
            "E_PantiesDown", Null(),
            "E_Panties == 'sports panties' and E_Wet", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Panties_Sport_SW.png",
            "E_Panties == 'sports panties'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Panties_Sport_S.png",
            "E_Panties and E_Wet", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Panties_SW.png",
            "E_Panties", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Panties_S.png",
            "True", Null(),
            )
    contains:
            # boots
        ConditionSwitch(
            "E_Hose == 'thigh boots'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Boots_Pussy.png",
            "True", Null(),
            )
    contains:
            # legs
        ConditionSwitch(
            "E_Legs == 'skirt'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Skirt_Pussy.png",
            "E_Upskirt", Null(),
            "E_Legs == 'pants' and E_Wet >= 2", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Pants_SW.png",
            "E_Legs == 'pants'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Pants_S.png",
            "True", Null(),
            )
    contains:
            # Over
        ConditionSwitch(
            "E_Over == 'nighty'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Nighty_Pussy.png",
            "True", Null(),
            )
    contains:
            # spunk
        ConditionSwitch(
            "'belly' in E_Spunk", +str(emma_cowgirl_loc)"/Emma_Spunk_Belly.png",
            "True", Null(),
            )
    zoom 1
#    offset (0,0)
...
image Emma_Cowgirl_Legs_A:
    ...
    contains:
            # anal spunk
        ConditionSwitch(
            "'anal' in E_Spunk and not Speed", +str(emma_cowgirl_loc)"/Emma_Spunk_Anal_Closed.png",
            "True", Null(),
            )
    contains:
            # Legs Base
            +str(emma_cowgirl_loc)"/Emma_Cowgirl_Legs_Anal.png"
    contains:
            #Anus
        ConditionSwitch(
    ...
    contains:
            # pubes
        ConditionSwitch(
            "E_Pubes", +str(emma_cowgirl_loc)"/Emma_Pubes_Anal.png",
            "True", Null(),
            )
    contains:
            # piercings
        ConditionSwitch(
            "E_Panties and not E_PantiesDown", Null(),
            "E_Legs and not E_Upskirt", Null(),
            "E_Pierce == 'barbell'", +str(emma_cowgirl_loc)"/Emma_Pierce_Barbell_Pussy_A.png",
            "E_Pierce == 'ring'", +str(emma_cowgirl_loc)"/Emma_Pierce_Ring_Pussy_A.png",
            "True", Null(),
            )
    contains:
            # panties
        ConditionSwitch(
            "E_PantiesDown", Null(),
            "E_Panties == 'sports panties' and E_Wet", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Panties_Sport_AW.png",
            "E_Panties == 'sports panties'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Panties_Sport_A.png",
            "E_Panties and E_Wet", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Panties_AW.png",
            "E_Panties", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Panties_A.png",
            "True", Null(),
            )
    contains:
            # pussy spunk
        ConditionSwitch(
            "'in' in E_Spunk", +str(emma_cowgirl_loc)"/Emma_Spunk_Anal_Pussy.png",
            "True", Null(),
            )
    contains:
            # boots
        ConditionSwitch(
            "E_Hose == 'thigh boots'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Boots_Anal.png",
            "True", Null(),
            )
    contains:
            # legs
        ConditionSwitch(
            "E_Legs == 'skirt'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Skirt_Anal.png",
            "E_Upskirt", Null(),
            "E_Legs == 'pants' and E_Wet >= 2", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Pants_AW.png",
            "E_Legs == 'pants'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Pants_A.png",
            "True", Null(),
            )
    contains:
            # Over
        ConditionSwitch(
            "E_Over == 'nighty'", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Nighty_Anal.png",
            "True", Null(),
            )
    contains:
            # spunk
...
image Emma_Cowgirl_Pussy_Mask:
    contains:
            +str(emma_cowgirl_loc)"/Emma_Cowgirl_Pussy_Mask.png"
    contains:
            # piercings
        ConditionSwitch(
            "E_Panties and not E_PantiesDown", Null(),
...
image Emma_Cowgirl_Hotdog_Mask:
    contains:
            +str(emma_cowgirl_loc)"/Emma_Cowgirl_Legs_HotdogMask.png"
#            yoffset 3
    contains:
            # piercings
        ConditionSwitch(
...
#                pause .3
    ...
    contains:
            #Overlay
            AlphaMask("Emma_Cowgirl_Legs_S", "Emma_Cowgirl_Hotdog_Mask")#+str(emma_cowgirl_loc)"/Emma_Cowgirl_Legs_HotdogMask.png")
            subpixel True
            anchor (.515,.5)
            pos (528,340) #top (528,300)
            zoom .95
...
image Emma_Cowgirl_Legs_S0:
    ...
    contains:
            #Overlay
            AlphaMask("Emma_Cowgirl_Legs_S", "Emma_Cowgirl_Pussy_Mask")#+str(emma_cowgirl_loc)"/Emma_Cowgirl_Pussy_Mask.png")
            subpixel True
            pos (0,-140) #top
            parallel:
                ease 1 ypos -135 #bottom
...
image Emma_Cowgirl_Anus_Mask_A1:
    ...
    contains:
        contains:
            +str(emma_cowgirl_loc)"/Emma_Cowgirl_Anus_Mask.png"
        contains:
                # spunk
            ConditionSwitch(
                "'anal' in E_Spunk", +str(emma_cowgirl_loc)"/Emma_Spunk_Anal_Open.png",
                "True", Null(),
                )
        subpixel True
        xzoom 0.5
...
image Emma_Cowgirl_Legs_A2:
    ...
    contains:
            #Overlay
            contains:
                    AlphaMask("Emma_Cowgirl_Legs_A", +str(emma_cowgirl_loc)"/Emma_Cowgirl_Anus_Mask.png" )
            contains:
                    # spunk
                ConditionSwitch(
                    "'anal' in E_Spunk", +str(emma_cowgirl_loc)"/Emma_Spunk_Anal_Open.png",
...
image Emma_Cowgirl_Anus_A0:
        ...
        +str(emma_cowgirl_loc)"/Emma_Cowgirl_Anus_Tight.png"
        xpos  0

image Emma_Cowgirl_Anus_A1:
        #this is the animated stretched anus
        contains:
            +str(emma_cowgirl_loc)"/Emma_Cowgirl_Anus_Open.png"
        contains:
                # spunk
            ConditionSwitch(
                "'anal' in E_Spunk", +str(emma_cowgirl_loc)"/Emma_Spunk_Anal_Under.png",
                "True", Null(),
                )
        subpixel True
        xzoom 0.5
