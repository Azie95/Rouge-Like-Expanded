...
image TempHairBack:
    +str(emma_sprite_loc)"/EmmaSprite_Head_HairBackWet.png"
    anchor (0.6, 0.0)
    zoom .5
...
image Emma_BJ_ONI_Backdrop:
    ...
    LiveComposite(
        ...
        (-375,250), ConditionSwitch(
            #blanket
            "'blanket' in E_RecentActions", +str(kitty_bj_loc)"/Kitty_BJFace_Blanket.png",
            "True", Null(),
            ),
        (0,0),+str(emma_bj_loc)"/Emma_TJ_Body.png",
            #body
        (0,0), ConditionSwitch(
            #tits
            "renpy.showing('Emma_TJ_Animation')", +str(emma_bj_loc)"/Emma_TJ_Tits.png", #Titjob animation
            "E_Chest == 'corset'", +str(emma_bj_loc)"/Emma_TJ_Tits_Up.png",   # E_TitsUp = 1
            "E_Chest == 'sports bra' or E_Chest == 'lace bra'", +str(emma_bj_loc)"/Emma_TJ_Tits_Up.png",   # E_TitsUp = 1
            "True", +str(emma_bj_loc)"/Emma_TJ_Tits_Down.png",   # E_TitsUp = 0
            ),
    ...
    LiveComposite(
        (858,928),
         (0,0), ConditionSwitch(
            ...
            "E_Hair", +str(emma_bj_loc)"/Emma_BJ_Hair_Wave_Mid.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
            # Basic Face layer
            "Speed <= 2 or Speed == 5 or not renpy.showing('Emma_BJ_Animation_ONI')", ConditionSwitch(
                    ...
                    "E_Blush", +str(emma_bj_loc)"/Emma_BJ_FaceClosed_Blush.png",
                    "True", +str(emma_bj_loc)"/Emma_BJ_FaceClosed.png",
                    ),
            "E_Blush", +str(emma_bj_loc)"/Emma_BJ_FaceOpen_Blush.png",
            "True", +str(emma_bj_loc)"/Emma_BJ_FaceOpen.png"
            ),
        (0,0), ConditionSwitch(
            #Mouth
            "Speed and renpy.showing('Emma_BJ_Animation_ONI')", ConditionSwitch(
                    # If in sucking position
                    "Speed == 1", +str(emma_bj_loc)"/Emma_BJ_Mouth_Tongue.png",  #licking
                    "(Speed == 2 or Speed == 5)", Null(),                          #heading
                    "Speed == 3", +str(emma_bj_loc)"/Emma_BJ_Mouth_Sucking.png", #sucking
                    "Speed == 4", +str(emma_bj_loc)"/Emma_BJ_Mouth_Sucking.png", #deepthroat
                    "Speed == 6", +str(emma_bj_loc)"/Emma_BJ_Mouth_Sucking.png", #cumming
                    ),
            "E_Mouth == 'normal'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Smile.png",
            "E_Mouth == 'lipbite'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Lipbite.png",
            "E_Mouth == 'sucking'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Sucking.png",
            "E_Mouth == 'kiss'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Kiss.png",
            "E_Mouth == 'sad'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Sad.png",
            "E_Mouth == 'smile'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Smile.png",
            "E_Mouth == 'smirk'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Smirk.png",
            "E_Mouth == 'grimace'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Smile.png",
            "E_Mouth == 'surprised'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Surprised.png",
            "E_Mouth == 'tongue'", +str(emma_bj_loc)"/Emma_BJ_Mouth_Tongue.png",
            "True", +str(emma_bj_loc)"/Emma_BJ_Mouth_Smile.png",
            ),
        ...
        (0,0), ConditionSwitch(
            ...
            "Speed and renpy.showing('Emma_BJ_Animation_ONI')", ConditionSwitch(
                    # If in sucking position
                    "Speed == 1", +str(emma_bj_loc)"/Emma_BJ_Spunk_Tongue.png",  #licking
                    "(Speed == 2 or Speed == 5)", Null(),                          #heading
                    "Speed == 3", +str(emma_bj_loc)"/Emma_BJ_Spunk_SuckingUnder.png", #sucking
                    "Speed == 4", +str(emma_bj_loc)"/Emma_BJ_Spunk_SuckingUnder.png", #deepthroat
                    "Speed == 6", +str(emma_bj_loc)"/Emma_BJ_Spunk_SuckingUnder.png", #cumming
                    ),
            "E_Mouth == 'normal'", +str(emma_bj_loc)"/Emma_BJ_Spunk_Smile.png",
            "E_Mouth == 'lipbite'", +str(emma_bj_loc)"/Emma_BJ_Spunk_Lipbite.png",
            "E_Mouth == 'kiss'", +str(emma_bj_loc)"/Emma_BJ_Spunk_Kiss.png",
            "E_Mouth == 'sad'", +str(emma_bj_loc)"/Emma_BJ_Spunk_Sad.png",
            "E_Mouth == 'smile'", +str(emma_bj_loc)"/Emma_BJ_Spunk_Smile.png",
            "E_Mouth == 'smirk'", +str(emma_bj_loc)"/Emma_BJ_Spunk_Smirk.png",
            "E_Mouth == 'surprised'", +str(emma_bj_loc)"/Emma_BJ_Spunk_Surprised.png",
            "E_Mouth == 'tongue'", +str(emma_bj_loc)"/Emma_BJ_Spunk_Tongue.png",
            "E_Mouth == 'sucking'", +str(emma_bj_loc)"/Emma_BJ_Spunk_SuckingUnder.png",
            "True", +str(emma_bj_loc)"/Emma_BJ_Spunk_Smile.png",
            ),
        (0,0), ConditionSwitch(
            #Brows
            "E_Brows == 'normal'", +str(emma_bj_loc)"/Emma_BJ_Brows_Normal.png",
            "E_Brows == 'angry'", +str(emma_bj_loc)"/Emma_BJ_Brows_Angry.png",
            "E_Brows == 'sad'", +str(emma_bj_loc)"/Emma_BJ_Brows_Sad.png",
            "E_Brows == 'surprised'", +str(emma_bj_loc)"/Emma_BJ_Brows_Surprised.png",
            "E_Brows == 'confused'", +str(emma_bj_loc)"/Emma_BJ_Brows_Confused.png",
            "True", +str(emma_bj_loc)"/Emma_BJ_Brows_Normal.png",
            ),
        (0,0), "Emma_BJ_ONI_Blink",
            #Eyes
        (0,0), ConditionSwitch(
            #cum on the face
            "'facial' in E_Spunk", +str(emma_bj_loc)"/Emma_BJ_Spunk_Facial.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
            #Hair overlay
            "E_Hair", +str(emma_bj_loc)"/Emma_BJ_Hair_Wave_Top.png",
            "True", Null(),
            ),
        )
    zoom 1.4
...
image Emma_BJ_ONI_Blink:
        #eyeblinks
        ConditionSwitch(
            "E_Eyes == 'normal'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Sexy.png",
            "E_Eyes == 'sexy'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Sexy.png",
            "E_Eyes == 'closed'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Closed.png",
            "E_Eyes == 'surprised'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Surprised.png",
            "E_Eyes == 'side'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Side.png",
            "E_Eyes == 'stunned'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Surprised.png",
            "E_Eyes == 'down'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Down.png",
            "E_Eyes == 'manic'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Surprised.png",
            "E_Eyes == 'squint'", +str(emma_bj_loc)"/Emma_BJ_Eyes_Squint.png",
            "True", +str(emma_bj_loc)"/Emma_BJ_Eyes_Sexy.png",
            ),
        choice:
            3.5
        choice:
        ...
        choice:
            3
        +str(emma_bj_loc)"/Emma_BJ_Eyes_Closed.png"
        .25
        repeat
...
image Emma_BJ_ONI_MouthHeading:
    ...
    contains:
        +str(emma_bj_loc)"/Emma_BJ_Mouth_Sucking.png"
        zoom 1.4
...
image Emma_BJ_ONI_MouthSuckingMask:
    ...
    contains:
        +str(emma_bj_loc)"/Emma_BJ_Mouth_SuckingMask.png"
        zoom 1.4
...
image Emma_BJ_ONI_MaskHeadingSpunk:
    #The composite for the heading mask that goes over the face
    contains:
            +str(emma_bj_loc)"/Emma_BJ_Spunk_SuckingOver.png"
            subpixel True
            anchor (0.5, 0.65)
