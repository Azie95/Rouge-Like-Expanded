...
image Emma_Doggy_Body = LiveComposite(                                                                                         #Upper body
        ...
        (0,0), ConditionSwitch(                                                                                 #Mouth
            ...
            #"E_Tan", Null(),
            "'mouth' in E_Spunk and E_Gag", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_BlowW.png",
            "E_Gag", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Blow.png",
            "'mouth' in E_Spunk and E_Mouth == 'lipbite'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_LipbiteW.png",
            "'mouth' in E_Spunk and E_Mouth == 'surprised'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_SurprisedW.png",
            "'mouth' in E_Spunk and E_Mouth == 'sucking'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_BlowW.png",
            "'mouth' in E_Spunk and E_Mouth == 'sad'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_SadW.png",
            "'mouth' in E_Spunk and E_Mouth == 'smile'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_SmileW.png",
            "'mouth' in E_Spunk and E_Mouth == 'tongue'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_TongueW.png",
            "'mouth' in E_Spunk", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_NormalW.png",
            "E_Mouth == 'normal'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Normal.png",
            "E_Mouth == 'lipbite'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Lipbite.png",
            "E_Mouth == 'sucking'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Blow.png",
            "E_Mouth == 'kiss'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Surprised.png",
            "E_Mouth == 'sad'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Sad.png",
            "E_Mouth == 'smile'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Smile.png",
            "E_Mouth == 'grimace'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Smile.png",
            "E_Mouth == 'surprised'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Surprised.png",
            "E_Mouth == 'tongue'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Tongue.png",
            "True", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Smile.png",
            ),
        # (0,0), ConditionSwitch(                                                                                 #Mouth
        #     "not E_Tan", Null(),
        #     "'mouth' in E_Spunk and E_Gag", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_BlowW.png",
        #     "E_Gag", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Blow.png",
        #     "'mouth' in E_Spunk and E_Mouth == 'lipbite'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_LipbiteW.png",
        #     "'mouth' in E_Spunk and E_Mouth == 'surprised'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_SurprisedW.png",
        #     "'mouth' in E_Spunk and E_Mouth == 'sucking'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_BlowW.png",
        #     "'mouth' in E_Spunk and E_Mouth == 'sad'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_SadW.png",
        #     "'mouth' in E_Spunk and E_Mouth == 'smile'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_SmileW.png",
        #     "'mouth' in E_Spunk and E_Mouth == 'tongue'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_TongueW.png",
        #     "'mouth' in E_Spunk", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_NormalW.png",
        #     "E_Mouth == 'normal'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Normal.png",
        #     "E_Mouth == 'lipbite'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Lipbite.png",
        #     "E_Mouth == 'sucking'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Blow.png",
        #     "E_Mouth == 'kiss'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Surprised.png",
        #     "E_Mouth == 'sad'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Sad.png",
        #     "E_Mouth == 'smile'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Smile.png",
        #     "E_Mouth == 'grimace'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Smile.png",
        #     "E_Mouth == 'surprised'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Surprised.png",
        #     "E_Mouth == 'tongue'", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Tongue.png",
        #     "True", +str(emma_doggy_loc)"/Emma_Doggy_T3Mouth_Smile.png",
        #     ),
                                                              #Body base
        #(0,0), ConditionSwitch(                                                                                 #Blush
        #    #"R_Blush and R_Gag == 'ballgag'", "images/RogueDoggy/Rogue_Doggy_BlushEvoBallGag.png",
        #    "E_Blush", +str(emma_doggy_loc)"/Emma_Doggy_BlushEvo.png",
        #    "True", Null(),
        #    ),
        (0,0), ConditionSwitch(                                                                                 #Mouth
            "E_Gag == 'ballgag'", +str(emma_doggy_loc)"/Emma_Doggy_Mouth_Ballgag.png",
            "True", Null(), #Emma_Doggy_Gag
            ),
        (0,0), "Emma Doggy Blink",
        (0,0), ConditionSwitch(                                                                                 #Brows
            "E_Brows == 'normal'", +str(emma_doggy_loc)"/Emma_Doggy_Brows_Normal.png",
            "E_Brows == 'angry'", +str(emma_doggy_loc)"/Emma_Doggy_Brows_Angry.png",
            "E_Brows == 'sad'", +str(emma_doggy_loc)"/Emma_Doggy_Brows_Sad.png",
            "E_Brows == 'surprised'", +str(emma_doggy_loc)"/Emma_Doggy_Brows_Surprised.png",
            "E_Brows == 'confused'", +str(emma_doggy_loc)"/Emma_Doggy_Brows_Normal.png",
        ...
        (0,0), ConditionSwitch(                                                                                 #tanktop
            "not E_Chest", Null(),
            "E_Chest == 'bikini'", +str(emma_doggy_loc)"/Emma_Doggy_BikiniTopWhite.png",
            "E_Chest == 'black bikini'", +str(emma_doggy_loc)"/Emma_Doggy_BikiniTopBlack.png",
            "E_Chest == 'corset'", +str(emma_doggy_loc)"/Emma_Doggy_CorsetWhite.png",
            "E_Chest == 'black corset'", +str(emma_doggy_loc)"/Emma_Doggy_CorsetBlack.png",
            "True", Null(),
            ),
        ...
        #    "R_Over == 'nighty'", "images/RogueDoggy/Rogue_Doggy_Over_NightyTop.png",
            "E_Over == 'towel'", +str(emma_doggy_loc)"/Emma_Doggy_Over_TowelTop.png",
            "True", Null(),
            ),
...
image Emma_Doggy_Ass = LiveComposite(                                                                                          #Lower body
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties back
            ...
            "E_Panties == 'white panties'", +str(emma_doggy_loc)"/Emma_Doggy_PantiesWhite_Back.png",
            "E_Panties == 'black panties'", +str(emma_doggy_loc)"/Emma_Doggy_PantiesBlack_Back.png",
            "E_Panties == 'bikini'", +str(emma_doggy_loc)"/Emma_Doggy_BikiniWhite_Back.png",
            "E_Panties == 'black bikini'", +str(emma_doggy_loc)"/Emma_Doggy_BikiniBlack_Back.png",
            #"E_Panties == 'blue shorts'", +str(emma_doggy_loc)"/Emma_Doggy_Shorts_Back.png",
            # "E_Panties == 'green panties'", +str(emma_doggy_loc)"/Emma_Doggy_Panties_Down_Back_Green.png",
            # "E_Panties == 'purple bikini panties'", +str(emma_doggy_loc)"/Emma_Doggy_Panties_Down_Back_Purple.png",
            #"E_Panties == 'black large panties'", +str(emma_doggy_loc)"/Emma_Doggy_UndiesBlack_Back.png",
            #"E_Panties == 'lace panties' or E_Panties == 'black panties'", +str(emma_doggy_loc)"/Emma_Doggy_Panties_Back.png",
            #"E_Panties == 'swimsuit1' or E_Panties == 'swimsuit2'", +str(emma_doggy_loc)"/Emma_Doggy_Swimsuit.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(                                                                                 #Wet look
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties back
            "not E_Hose", Null(),
            "E_Hose == 'white thigh high'", +str(emma_doggy_loc)"/Emma_Doggy_Legs_ThighHighWhite.png",
            "E_Hose == 'black thigh high'", +str(emma_doggy_loc)"/Emma_Doggy_Legs_ThighHighBlack.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(                                                                                 #Wet look
        ...
        #    "R_Panties == 'green panties' and R_Wet > 1", "images/RogueDoggy/Rogue_Doggy_Undies_Down_Wet.png",
            "E_Panties == 'white panties'", +str(emma_doggy_loc)"/Emma_Doggy_PantiesWhite_Down.png",
            "E_Panties == 'black panties'", +str(emma_doggy_loc)"/Emma_Doggy_PantiesBlack_Down.png",
            "E_Panties == 'bikini'", +str(emma_doggy_loc)"/Emma_Doggy_BikiniWhite_Down.png",
            "E_Panties == 'black bikini'", +str(emma_doggy_loc)"/Emma_Doggy_BikiniBlack_Down.png",
        ...
        #    "E_Legs == 'pants' and not E_Upskirt and E_HairColor == 'black'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlacE_Panties.png",
        #    "E_Legs == 'pants' and not E_Upskirt and E_HairColor == 'blonde'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlonde_Panties.png",
        #    "E_Legs == 'pants' and not E_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Pubes_Panties.png",
        #    "E_PantiesDown and E_HairColor == 'black'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlack.png",
        #    "E_PantiesDown and E_HairColor == 'blonde'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlonde.png",
        #    "E_PantiesDown", +str(emma_doggy_loc)"/Emma_Doggy_Pubes.png",
        #    "E_Panties and E_HairColor == 'black'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlacE_Panties.png",
        #    "E_Panties and E_HairColor == 'blonde'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlonde_Panties.png",
        #    "E_Panties", +str(emma_doggy_loc)"/Emma_Doggy_Pubes_Panties.png",
        #    "E_Hose and E_Hose != 'stockings' and E_HairColor == 'black'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlacE_Panties.png",
        #    "E_Hose and E_Hose != 'stockings' and E_HairColor == 'blonde'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlonde_Panties.png",
        #    "E_Hose and E_Hose != 'stockings'", +str(emma_doggy_loc)"/Emma_Doggy_Pubes_Panties.png",
        #    "True and R_HairColor == 'black'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlack.png",
        #    "True and R_HairColor == 'blonde'", +str(emma_doggy_loc)"/Emma_Doggy_PubesBlonde.png",
        #    "True", +str(emma_doggy_loc)"/Emma_Doggy_Pubes.png",
        #    ),
        # (0,0), ConditionSwitch(                                                                                 #Pussy Piercings
        #     "P_Sprite", Null(),
        #     "E_Pierce == 'ring'", +str(emma_doggy_loc)"/Emma_Doggy_Pussy_Ring.png",
        ...
        (0,0), ConditionSwitch(                                                                                 #Anus Composite
            ...
            "P_Sprite and P_Cock == 'plug' and E_Plugged", +str(emma_doggy_loc)"/Emma_Doggy_Plugged.png",
            "P_Sprite and P_Cock == 'plug'", "Emma_Anal_Plug",
            "E_Plugged", +str(emma_doggy_loc)"/Emma_Doggy_Plugged.png",
            ...
            "E_Loose", +str(emma_doggy_loc)"/Emma_Doggy_Asshole_Loose.png",
        ...
        (0,0), ConditionSwitch(                                                                                 #Hose
            "E_Spank >= 1 and E_Spank <= 4 and E_Plugged", +str(emma_doggy_loc)"/Emma_Doggy_SpankPlugged1.png",
            "E_Spank >= 1 and E_Spank <= 4 and (P_Cock == 'anal' or P_Cock == 'plug')", +str(emma_doggy_loc)"/Emma_Doggy_SpankAnal1.png",
            "E_Spank >= 1 and E_Spank <= 4", +str(emma_doggy_loc)"/Emma_Doggy_Spank1.png",
            "E_Spank >= 5 and E_Spank <= 10 and E_Plugged", +str(emma_doggy_loc)"/Emma_Doggy_SpankPlugged2.png",
            "E_Spank >= 5 and E_Spank <= 10 and (P_Cock == 'anal' or P_Cock == 'plug')", +str(emma_doggy_loc)"/Emma_Doggy_SpankAnal2.png",
            "E_Spank >= 5 and E_Spank <= 10", +str(emma_doggy_loc)"/Emma_Doggy_Spank2.png",
            "E_Spank >= 11 and E_Plugged", +str(emma_doggy_loc)"/Emma_Doggy_SpankPlugged3.png",
            "E_Spank >= 11 and (P_Cock == 'anal' or P_Cock == 'plug')", +str(emma_doggy_loc)"/Emma_Doggy_SpankAnal3.png",
            "E_Spank >= 11", +str(emma_doggy_loc)"/Emma_Doggy_Spank3.png",
            "True", Null(),
            ),
        ...
        #    "E_Panties == 'green panties' and R_Wet", "images/RogueDoggy/Rogue_Doggy_Undies_Wet.png",
            "E_Panties == 'white panties'", +str(emma_doggy_loc)"/Emma_Doggy_PantiesWhite.png",
            "E_Panties == 'black panties'", +str(emma_doggy_loc)"/Emma_Doggy_PantiesBlack.png",
            "E_Panties == 'bikini'", +str(emma_doggy_loc)"/Emma_Doggy_BikiniWhite.png",
            "E_Panties == 'black bikini'", +str(emma_doggy_loc)"/Emma_Doggy_BikiniBlack.png",
        ...
        (0,0), ConditionSwitch(                                                                                 #Legs Layer
            #"E_Legs == 'capris' and E_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Legs_Pants_Down.png",
            #"E_Legs == 'capris' and E_Wet > 1", +str(emma_doggy_loc)"/Emma_Doggy_Legs_Pants_Wet.png",
            #"E_Legs == 'capris'", +str(emma_doggy_loc)"/Emma_Doggy_Legs_Pants.png",
            "E_Legs == 'black pants' and E_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Pants_Black_Down.png",
            "E_Legs == 'black pants' and E_Wet > 1", +str(emma_doggy_loc)"/Emma_Doggy_Pants_Black_Wet.png",
            "E_Legs == 'black pants'", +str(emma_doggy_loc)"/Emma_Doggy_Pants_Black.png",
            "E_Legs == 'pants' and E_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Pants_White_Down.png",
            "E_Legs == 'pants' and E_Wet > 1", +str(emma_doggy_loc)"/Emma_Doggy_Pants_White_Wet.png",
            "E_Legs == 'pants'", +str(emma_doggy_loc)"/Emma_Doggy_Pants_White.png",
        #    "E_Legs == 'skirt' and E_Upskirt and P_Sprite and P_Cock == 'anal' and Speed" , +str(emma_doggy_loc)"/Emma_Doggy_Legs_Skirt_UpAnal.png",
        #    "E_Legs == 'skirt' and E_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Legs_Skirt_Up.png",
        #    "E_Legs == 'skirt'", +str(emma_doggy_loc)"/Emma_Doggy_Legs_Skirt.png",
        #    "E_Legs == 'skirtshort' and E_Upskirt and P_Sprite and P_Cock == 'anal' and Speed" , +str(emma_doggy_loc)"/Emma_Doggy_Legs_SkirtShort_UpAnal.png",
        #    "E_Legs == 'skirtshort' and E_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Legs_SkirtShort_Up.png",
        #    "E_Legs == 'skirtshort'", +str(emma_doggy_loc)"/Emma_Doggy_Legs_SkirtShort.png",
        #    "E_Legs == 'cheerleader skirt' and E_Upskirt and P_Sprite and P_Cock == 'anal' and Speed" , +str(emma_doggy_loc)"/Emma_Doggy_CheerleadeK_Skirt_UpAnal.png",
        #    "R_Legs == 'cheerleader skirt' and R_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Cheerleader_Skirt_Up.png",
        #    "R_Legs == 'cheerleader skirt'", +str(emma_doggy_loc)"/Emma_Doggy_Cheerleader_Skirt.png",
        #    "R_Legs == 'cheerleader skirtshort' and R_Upskirt and P_Sprite and P_Cock == 'anal' and Speed" , +str(emma_doggy_loc)"/Emma_Doggy_Cheerleader_SkirtShort_UpAnal.png",
        #    "R_Legs == 'cheerleader skirtshort' and R_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Cheerleader_SkirtShort_Up.png",
        #    "R_Legs == 'cheerleader skirtshort'", +str(emma_doggy_loc)"/Emma_Doggy_Cheerleader_SkirtShort.png",
            "True", Null(),
            ),
        ...
        #    "R_Over == 'nighty'", "images/RogueDoggy/Rogue_Doggy_Over_NightyAss.png",
            "E_Over == 'towel' and E_Upskirt", +str(emma_doggy_loc)"/Emma_Doggy_Over_TowelAss_Up.png",
            "E_Over == 'towel'", +str(emma_doggy_loc)"/Emma_Doggy_Over_TowelAss.png",
            "True", Null(),
            ),
...
image Emma Doggy Blink:                                                                                        #Eyes
    ConditionSwitch(
    "E_Eyes == 'sexy'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Sexy.png",
    "E_Eyes == 'side'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Side.png",
    "E_Eyes == 'normal'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Normal.png",
    "E_Eyes == 'closed'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Closed.png",
    "E_Eyes == 'manic'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Surprised.png",
    "E_Eyes == 'down'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Sexy.png",
    "E_Eyes == 'stunned'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Stunned.png",
    "E_Eyes == 'surprised'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Surprised.png",
    "E_Eyes == 'squint'", +str(emma_doggy_loc)"/Emma_Doggy_Eyes_Sexy.png",
...
image Emma_Pussy:                                                                                              #Full Animation for speed 0
    contains:
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Pussy_FBase.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Pussy_FBase.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Pussy_FBase.png",
        # ),                                                                                 #Base
    contains:                                                                                   #Cock
        "Zero_Doggy_Insert"
    ...
    contains:
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Pussy_FMask.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Pussy_FMask.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Pussy_FMask.png",
        # ),                                                                                   #Mask
...
image Emma_Pussy_Moving:                                                                                       #Full Animation for speed 1
    ...
    contains:                                                                                   #Base
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Pussy_FHole.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Pussy_FHole.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Pussy_FHole.png",
        # ),
        subpixel True
        anchor (0.52,0.69)
        pos (217,518)
...
image Emma_Pussy_Heading: #This is the image impacted by the mask for the pussy flap in "Emma_Pussy_Moving"
    contains:                                                                                   #Mask
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Pussy_FHeading.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Pussy_FHeading.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Pussy_FHeading.png",
        # ),
        anchor (0.52,0.69)
        pos (217,515)
        zoom 1
...
image Emma_Anal2:                                                                                               #Anal static
    contains:                                                                                   #Base
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullBase.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullBase.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Anal_FullBase.png",
        # ),
    contains:
        "Emma_Doggy_Anal_FullHole"
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullHole.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullHole.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Anal_FullHole.png",
        # ),                                         #Hole
        anchor (0.52,0.69)
        pos (218,518)
        zoom .5
    ...
    contains:                                                                                   #Mask
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullMask.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullMask.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Anal_FullMask.png",
        # ),
        anchor (0.52,0.69)
        pos (218,518)
        zoom .5
    contains:
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullCheeks.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullCheeks.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Anal_FullCheeks.png",
        # ),
...
image Emma_Anal:                                                                                               #Anal static Loose
    contains:                                                                                   #Base
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Asshole_Loose.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Asshole_Loose.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Asshole_Loose.png",
        # ),
        anchor (0.50,0.69)
        pos (208,500)
        zoom 1.25
...
image Emma_Anal_Plug_Heading:                                                                                       #Animation for speed 1
    contains:                                                                                   #Base
        ...
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Anal_FullBase.png",
        # ),
        #+str(emma_doggy_loc)"/Emma_Doggy_Anal_HeadingBase.png"
    contains:
        "Emma_Doggy_Anal_FullHole"
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullHole.png",
        ...
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Anal_FullHole.png",
        # ),                                         #Hole
        #+str(emma_doggy_loc)"/Emma_Doggy_Anal_HeadingBase.png"                                       #Hole
        anchor (0.52,0.69)
        pos (218,518)
        zoom .4
        block:
    ...
    contains:                                                                                   #Mask
        ...
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullMask_Plug.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullMask_Plug.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Anal_FullMask_Plug.png",
        # ),
        #+str(emma_doggy_loc)"/Emma_Doggy_Anal_HeadingMask_Plug.png"
        anchor (0.52,0.69)
        pos (218,518)
        zoom .4
        block:
...
image Emma_Doggy_Anal_Fucking:                                                                                       #Animation for speed 2 Ass
    ...
    #     # ),
    contains:                                                                                   #Cock
        AlphaMask("Zero_Doggy_Anal1", +str(emma_doggy_loc)"/Emma_Doggy_AnalMask.png")
    contains:                                                                                   #Mask
        "Emma_Doggy_Anal_FullMask"
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullMask.png",
...
image Emma_Doggy_Anal_Fucking2:                                                                                      #Animation for speed 3 Ass
    ...
    #     # ),
    contains:                                                                                   #Cock
        AlphaMask("Zero_Doggy_Anal2", +str(emma_doggy_loc)"/Emma_Doggy_AnalMask.png")
    contains:                                                                                   #Mask
        "Emma_Doggy_Anal_FullMask"
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullMask.png",
...
image Emma_Doggy_Anal_Fucking3:                                                                                      #Animation for speed 3 Ass
    ...
    #     # ),
    contains:                                                                                   #Cock
        AlphaMask("Zero_Doggy_Anal3", +str(emma_doggy_loc)"/Emma_Doggy_AnalMask.png")
    contains:                                                                                   #Mask
        "Emma_Doggy_Anal_FullMask3"
        # ConditionSwitch(
        # "E_Tan", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullMask3.png",
        # "E_Tan == 'tan3'", +str(emma_doggy_loc)"/Emma_Doggy_T3Anal_FullMask3.png",
        # "True", +str(emma_doggy_loc)"/Emma_Doggy_Anal_FullMask3.png",
        # ),
    contains:                                                                                   #Cheeks
        "Emma_Doggy_Anal_FullCheeks"
        # ConditionSwitch(
