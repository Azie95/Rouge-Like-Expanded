...
label Rogue_SexDialog(TempLine = 0, TempLust = 0, TempLust2 = 0):
    ...
    if Trigger == "hand":
            ...
            if not Speed:
                        ...
                        $ R_Addict -= 1 if D20S > 10 else 2
                        return
            
            if R_Hand > 4:                          # After the 5th time 
                        if Speed <= 1:                      #slow 
                    ...
                    if Speed <= 1:                      #slow
                        $ Line = Line + renpy.random.choice(["Rogue makes up for her inexperience with determination, carefully stroking your cock", 
    ...
    #End Handy dialog ////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if R_Tit > 4 and R_Blow:                                        #5th+ and blown
                        if Speed <= 1:                                              #slow
                            $ Line = renpy.random.choice(["Rogue rocks her breasts up and down around your cock", 
                                    "Rogue lightly licks the head as it pops up between her tits", 
                                    "Rogue has a smooth motion going now, gentle and precise",
                                    "Rogue pauses to rub her nipples across the shaft",
                                    "In between strokes Rogue gently sucks on the head",
                                    "Rogue drips some spittle down to make sure you're properly lubed",
                                    "Rogue gently caresses the shaft between her tits"])            
                            
                            $ TempFocus += 15 if P_Focus < 70 else 5                      
                            $ TempLust += 7 if R_Lust > 60 else 4       
                        else:                                                       #fast
                            $ Line = renpy.random.choice(["Rogue rapidly rocks her breasts up and down around your cock", 
                                    "Rogue licks away at the head every time it pops up between her tits", 
                                    "Rogue has a smooth motion going now, quick by efficient",
                                    "Rogue dancers her nipples across the shaft",
                                    "In as she strokes faster and faster, Rogue bends down to suck on the head",
                                    "Rogue covers her tits with drool to keep them well lubed",
                                    "Rogue rapidly caresses the shaft between her tits"])
                            
                            $ TempFocus += 20 if P_Focus > 40 else 5                      
                            $ TempLust += 6 if R_Lust > 70 else 4    
                     
                
            elif R_Tit > 1:                                                 #third through 5th time
                    if Speed <= 1:                                              #slow
                        $ Line = renpy.random.choice(["Rogue juggles her breasts up and down around your cock", 
                                "Rogue lightly strokes the head as it pops up between her tits", 
                                "Rogue has a smooth motion going now, gentle and precise",
                                "Rogue pauses to rub her nipples across the shaft",
                                "Rogue gently caresses the shaft between her tits"]) 
                        ...
                        $ Line = renpy.random.choice(["Rogue rapidly juggles her breasts up and down around your cock", 
                            "Rogue lightly brushes the head with her chin as it pops up between her tits", 
                            "Rogue moves them up and down in a fluid rocking motion",
                            "Rogue bounces her whole body up and down",
                            "Rogue rapidly slides the shaft between her tits"])   
                        
                        $ TempFocus += 15 if P_Focus > 50 else 7                      
                        $ TempLust += 6 if R_Lust > 60 else 4    
                       
            else:                                                           #First and second time
                    if Speed <= 1:                                              #slow
                        $ Line = renpy.random.choice(["Rogue sort of squishes her breasts back and forth around your cock", 
                            "Rogue slides the cock up and down between her cleavage", 
                            "Rogue kind of bounces her tits around your cock",
                            "Rogue smooshes her cleavage as tight as she can and rubs up and down"])
                        
                        $ TempFocus += 12 if P_Focus < 60 else 6                      
                        $ TempLust += 6 if R_Lust > 60 else 3    
                                        
                    else:                                                       #fast
                        $ Line = renpy.random.choice(["Rogue sort of bounces her breasts off your cock", 
                            "Rogue tries to quickly slide the cock up and down between her cleavage, but it tends to slide out", 
                            "Rogue slaps her tits against your dick",
                            "Rogue smooshes her cleavage as tight as she can and rubs up and down quite quickly"])  
                        
                        $ TempFocus += 8 if P_Focus > 70 else 4                      
                        $ TempLust += 5 if R_Lust > 60 else 3    
    ...
    #End Action Titfuck ///////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed: #if Rogue is not moving                
                    if "hungry" in R_Traits:
                            call RogueFace("sly") from _call_RogueFace_857
                            $ Line = "Rogue stares at your cock. She licks her lips in anticipation"
                            $ TempLust += 3 if R_Lust < 40 else 1                    
                    elif R_Blow > 2:
                            call RogueFace("sly") from _call_RogueFace_858
                            $ Line = "Rogue stares at your cock. She seems pretty excited about it"
                            $ TempLust += 2 if R_Lust < 60 else 0
                    else:
                            call RogueFace("perplexed") from _call_RogueFace_859
                            $ Line = "Rogue stares at your cock with trepidation"
                            $ TempLust += 2 if R_Lust < 40 else 0                    
                            $ TempFocus += -3 if P_Focus > 50 else 2
                    ...
                    return
                        ...
                        $ Line = "Rogue continues to lick your cock. "        #if Rogue is the primary but is licking
            else: 
                        $ Line = "Rogue continues to suck your cock. "        #if Rogue is the primary and is heading or sucking
             
            if Speed == 1:                                                                  #Speed 1 (licking)
                    if R_Blow > 4:                                                                  #After the 5th time
                            ...
                            $ Line = Line + renpy.random.choice(["Rogue makes up for her inexperience with determination, carefully licking your cock", 
                    ...
                    if R_Blow > 4:                                                                  #After the 5th time
                            ...
                            $ TempFocus += 20 if P_Focus > 40 else 5                      
                            $ TempLust += -3 if R_Lust < 60 else -1                        
                            $ TempLust += 5 if R_Obed > 500 else 0  
                            ...
                            $ TempLust += -5 if R_Lust < 60 else -2                       
                            $ TempLust += 7 if R_Obed > 500 else 0  
                    $ R_Addict -= 3
    ...
    # end R_Blowjob                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if R_Sex > 4:
                if Speed > 1:                       # After the 5th time fast
                        ...
                        $ TempLust += 16 if R_Lust > 70 else 10                    
                        ...
                        $ TempLust += 12 if 40 > R_Lust > 90 else 10                        
                        
            elif R_Sex > 1:
                if Speed > 1:             #third through 5th time fast
                    $ Line = Line + renpy.random.choice(["Rogue bounces rapidly against your cock", 
                        "You thrust into her and she squeaks a bit",
                        "You quickly grind back and forth inside her",
                        "You alternate between shallow rapid thrusts, and the occasional deep, slow one",
                        "You pound away at her",    
                    ...
                    $ TempLust += 14 if R_Lust > 80 else 10
                    ...
                    $ TempLust += 10 if 50 > R_Lust > 90 else 8
                ...
                if Speed > 1:            # First and second time fast
                    ...
                    $ TempLust += 10 if R_Lust > 80 else 6
                    ...
                    $ TempLust += 8 if 60 > R_Lust > 90 else 6
    ...
    # end R_Sex                                 ////////////////////////////////////////////////////////////////////////////// 
            ...
            $ TempLust2 = 2
            if R_Panties and not R_PantiesDown: #if panties are in the way
                $ TempLust2 -= 1
            if HoseNum("Rogue") >= 6: #if complete hose
                $ TempLust2 -= 1        
            if R_Legs and not R_Upskirt: #If pants/skirt is up
            ...
            if not Speed:
                ...
                return
                    ...
                    $ Line = "You continue to hotdog Rogue. "       
            else: 
                    $ Line = "You continue to grind against Rogue. " 
            ...
            if R_Hotdog >= 2:
                if Speed > 1:       # After the 2ndtime fast
                    ...
                    $ TempLust += (TempLust2 + 8) if 50 > R_Lust > 80 else (TempLust2 + 2)
                    ...
                    $ TempLust += (TempLust2 + 7) if 30 > R_Lust > 70 else (TempLust2 + 3)
                ...
                if Speed > 1:       #fast
                    ...
                    $ TempLust += (TempLust2 + 4) if 50 > R_Lust > 80 else (TempLust2 + 2)
                    ...
                    $ Line = Line + renpy.random.choice(["She grinds slowly against your cock", 
                        ...
                        "She slides slowly back and forth along your cock"])
                    $ TempFocus += (TempLust2 + 5) if P_Focus < 60 else (TempLust2 + 3)
                    $ TempLust += (TempLust2 + 5) if 50 > R_Lust > 70 else (TempLust2 + 2)
    ...
    # end R_Hotdog                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if R_Anal >= 5:
                    if Speed > 1:#Fast
                            ...
                            $ TempLust += 14 if R_Lust > 80 else 9
                            ...
                            $ TempLust += 12 if 50 < R_Lust < 90 else 8
                              
            elif R_Loose:     #You've done some anal stuff before       
                    if Speed > 1:             #third through 5th time fast
                            $ Line = Line + renpy.random.choice(["She bounces rapidly against your cock", 
                                "You thrust into her and she squeaks a bit",
                                "You quickly grind back and forth inside her",
                            ...
                            $ TempLust += 12 if R_Lust > 80 else 6
                            ...
                            $ TempLust += 8 if 70 > R_Lust > 90 else 4
                    ...
                    if Speed > 1:            #fast
                            $ Line = Line + renpy.random.choice(["She bounces rapidly against your cock but seems to be in pain", 
                                ...
                                "You pound away at her",    
                                "She moves rapidly back and forth along your cock, but seems a bit uncomfortable"])
                            $ TempFocus += 10 if P_Focus > 60 else 8                   
                            $ TempLust += 2 if R_Lust > 80 else -3
                            ...
                            if R_Lust > 70:
                                ...
                                $ R_Lust = Statupdate("Rogue", "Lust", R_Lust, 10, -1, 1)
                            $ R_Lust = Statupdate("Rogue", "Lust", R_Lust, 200, 2) 
                            
                            $ TempFocus += 10 if P_Focus > 60 else 6                   
                            $ TempLust += 4 if R_Lust > 60 else -1
            
            if R_Loose > 1:                                                         #If she's extra loose
                $ TempLust += 1
                
            $ TempLust = 0 if (R_Lust - TempLust) < 0 else TempLust
            
    # end R_Anal                                 //////////////////////////////////////////////////////////////////////////////
    
    elif Trigger == "fondle breasts":   
                    $ Line = "You continue to fondle Rogue. "    
                    if R_Over and R_Chest: #Full top
                                ...
                                $ TempLust += 4 if R_Lust > 50 else 2
                    elif R_Over:        #Just overtop
                                ...
                                $ TempLust += 6 if R_Lust > 40 else 4  
                    else: #topless
                                $ Line = Line + renpy.random.choice(["You reach out and massage her glorious breasts", 
                                ...
                                $ TempLust += 6 if R_Lust > 50 else 3  
                    $ R_Addict -= 2
                  
    # end R Fondle breasts                                 //////////////////////////////////////////////////////////////////////////////
    elif Trigger == "suck breasts":  
                    $ Line = "You continue to suck on Rogue's breasts. "    
                    if R_Over and R_Chest: #Full top
                                ...
                                $ TempFocus += 2 if P_Focus < 50 else 1  
                                $ TempLust += 2 if R_Lust < 30 else 1
                    elif R_Over:        #Just overtop
                                $ Line = renpy.random.choice(["You bend down and motor-boat her breasts",
                                ...
                                $ TempFocus += 2 if P_Focus < 50 else 1
                                $ TempLust += 5 if R_Lust > 50 else 3
                    elif R_Chest:       #just bra
                                $ Line = renpy.random.choice(["You bend down and motor-boat her breasts",
                                ...
                                $ TempLust += 10 if R_Lust > 40 else 7
                                $ R_Addict -= 2
                    else: #topless
                                $ Line = renpy.random.choice(["You bend down and motor-boat her breasts",
                                    "You gently nibble at her nipples as you suck on them",
                                ...
                                $ TempLust += 10 if R_Lust > 50 else 7  
                                $ R_Addict -= 2
           
    # end R Suck breasts                                 //////////////////////////////////////////////////////////////////////////////
        
    elif Trigger == "fondle thighs":  #Trigger4 not available
                    $ Line = "You continue to massage Rogue's thighs. "   
    ...
    # end R fondle thighs                               //////////////////////////////////////////////////////////////////////////////
                    ...
                    if Speed == 2 and D20S <= 10:
                            $ Line = renpy.random.choice(["You continue to finger Rogue's pussy. ", 
                                                    "You continue to finger bang Rogue's pussy. ",
                                                    "You continue to finger blast Rogue's pussy. "])
                            ...
                            $ TempLust += 6 if R_Lust > 40 else 3
                            $ R_Addict -= 2  
                                
                    else: #if not fingerblasting or not high rolls
                            $ Line = renpy.random.choice(["You continue to stroke Rogue's pussy. ", 
                                                    "You continue to rub Rogue's pussy. ",
                                                    "You continue to caress Rogue's pussy. "])
                            ...
                            if R_Legs == "pants" and not R_Upskirt:
                                    ...
                                    if R_Panties == "shorts" and not R_PantiesDown: #shorts on
                                            ...
                                            if D20S <= 10:
                                                ...
                                                $ TempLust += 4 if R_Lust > 40 else 2
                                                $ R_Addict -= 2  
                            ...
                            if D20S > 10:#If it touches skin
                                ...
                                $ TempFocus += 2 if P_Focus < 50 else 1  
                                $ TempLust += 2 if R_Lust > 40 else 1
    ...
    # end R fondle pussy                               /////////////////////////////////////////////////////////////////////////////
                            ...
                            $ Line = renpy.random.choice(["You continue to lick Rogue's pussy. ", 
                                                    "You continue to suck Rogue's pussy. ",
                                                    "You continue to tongue Rogue's pussy. "])
                            ...
                            if R_Legs == "pants" and not R_Upskirt:
                                        ...
                                        if R_Panties == "shorts" and not R_PantiesDown: #shorts on
                                               ...
                                               $ Line = renpy.random.choice(["You push her skirt up and lick at her pussy through her hose",                 
                                                ...
                                                if D20S <= 10:
                                                    ...
                                                    $ TempLust += 4 if R_Lust > 60 else 2
                                                    $ R_Addict -= 3  
                                                else: #If it touches skin
                                                    $ TempFocus += 1 
                                                    $ TempLust += 1
                                ...
                                if D20S > 10: #If it touches skin
                                    ...
                                    $ TempLust += 10 if R_Lust > 60 else 5
                                    $ R_Addict -= 3  
                                else: 
                                    $ TempFocus += 2 if P_Focus < 50 else 1  
                                    $ TempLust += 5 if R_Lust > 60 else 3
    ...
    # end R lick pussy                               /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Line = renpy.random.choice(["You continue to fondle Rogue's ass. ", 
                                                "You continue to feel up Rogue's ass. ",
                                                "You continue to grope Rogue's ass. "])
    ...
    # end R fondle ass                               /////////////////////////////////////////////////////////////////////////////
                            ...
                            $ Line = renpy.random.choice(["You continue to finger Rogue's asshole. ", 
                                                    "You continue to finger bang Rogue's asshole. ",
                                                    "You continue to finger Rogue's rim. "])
                            ...
                            $ TempFocus += 2 if P_Focus < 50 else 1  
                            $ TempLust += 6 if R_Lust > 70 else 3
                            if not R_Loose:
                                    $ TempLust -= 3
                            elif R_Loose < 2:
                                    $ TempLust += 1   
    ...
    # end R insert ass                              /////////////////////////////////////////////////////////////////////////////
                            ...
                            $ Line = renpy.random.choice(["You continue to lick Rogue's ass. ", 
                                                    "You continue to suck Rogue's ass. ",
                                                    "You continue to tongue Rogue's ass. "])
                            ...
                            if R_Legs == "pants" and not R_Upskirt:
                                ...
                                if D20S > 10: #If it touches skin
                                    ...
                                    $ TempLust += 9 if R_Lust > 60 else 4
                                    $ R_Addict -= 3  
                                else: 
                                    $ TempFocus += 1 if P_Focus < 50 else 0  
                                    $ TempLust += 4 if R_Lust > 60 else 2
                
                            $ TempLust += 2 if R_Loose > 1 else 0 #Bonus lust if she's anal experienced
    ...
    # end R lick ass                               /////////////////////////////////////////////////////////////////////////////
                        ...
                        if R_Legs == "pants" and not R_Upskirt:
                                ...
                                if (R_Legs == "skirt" or R_Legs == "cheerleader skirt") and R_Panties:           
                                    ...
                                    $ TempFocus += 3 if P_Focus < 50 else 1  
                                    $ TempLust += 10 if R_Lust > 70 else 8
    # end R dildo pussy                              /////////////////////////////////////////////////////////////////////////////
    ...
    # end R dildo ass                              /////////////////////////////////////////////////////////////////////////////
                ...
                call Rogue_Self_Lines from _call_Rogue_Self_Lines_1  
...
#                $ TempLust = 0
    ...
    # end R Masturbation                               /////////////////////////////////////////////////////////////////////////////
                ...
                call Rogue_SexDialog_Threeway("lesbian") from _call_Rogue_SexDialog_Threeway_1      
                        ...
                        if R_Kissed > 10 and R_Love >= 700:#Loving
                                ...
                                $ TempLust += 3 if R_Lust < 50 else 0
                                $ TempLust += 1 if R_Lust < 90 else 0
                        elif R_Kissed > 5:#reasonably experienced        
                                ...
                                $ Line = renpy.random.choice(["She tentatively presses her lips against yours", 
                                        ...
                                        "Your hands slide down her body as your lips brush hers"]) 
                                $ TempFocus += 1 if P_Focus < 70 else 0  
                                $ TempLust += 2 if R_Lust < 30 else 0
                                $ TempLust += 1 if R_Lust < 70 else 0
...
label Rogue_Self_Lines(Mode = "T3", Action = Trigger3, TempLustX = 0): 
    ...
    if not Action or D20S >= 15: 
            if Trigger != "masturbation" and "passive" in R_Traits:
                    # This bypasses self-set if Rogue is told not to take initiative
                    $ Line = 0
                    return            
            call Rogue_Self_Set(Mode, Action) from _call_Rogue_Self_Set
    ...
    if Action == "hand": 
            ...
            $ TempFocus += 2 if R_Hand > 2 else 0
                    
            $ TempLustX += 2 if R_Lust < 60 else 1
            $ TempLustX += 2 if R_Hand > 2 else 0
            $ R_Addict -= 1            
    else:
        if R_Lust >= 80:   
            ...
            #End R_Lust >= 80
                ...
                if Action == "fondle pussy":
                        ...
                        $ Line = Line + renpy.random.choice(["She gently rubs her breasts, dragging a finger across her nipple", 
                                ...
                                "She gasps as her finger brushes against an erect nipple"])   
                #End R_Lust 0-60
        #End Rogue Action masturbation dialog        
                        
            
        # Rogue Self-stat boosts  
        $ TempLustX += 4 if R_Lust > 80 else 0        
        $ TempLustX += 5 if R_Lust < 40 else 3                   #Bonus if she is relatively low lust
        $ TempLustX += 5 if Trigger == "masturbation" else 0     #Bonus if masturbation is her primary action
        
        if Primary == "Rogue": #If this is a primary, Trigger3 action
            $ TempLust = TempLustX
    ...
    #End Rogue Action all dialog     
    
    return
# end Rogue_Self_Lines / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /




# Start Rogue_Self_Set / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
label Rogue_Self_Set(Mode = "T3", Action = Trigger3, Length=0, Count2=0, Options =[]): 
    #If T3/Trigger3 is sent, this is for Rogue's Primary role, offhand behavior
    #If T5/Trigger5 is sent, this is for Rogue's Second role, threesome behavior
    if Mode == "T3" and Trigger != "masturbation":
            ...
            if Taboo and R_SEXP >= 50 and ApprovalCheck("Rogue", 500, "I"):
                if R_Lust <= 50:
                    return
            elif R_SEXP >= 25 and ApprovalCheck("Rogue", 300, "I"):
                if R_Lust <= 30:
                    return
            else:
                    return
    ...
    if Trigger == "masturbation":
                ...
                if Trigger not in ("anal", "fondle ass", "insert ass", "lick ass", "dildo anal") and R_Loose:
                        if "dildo" in R_Inventory:
                            $ Options.append("dildo anal")
                ...
                if "fondle pussy" not in Options and (R_Obed < R_Inbt):
                        $ Options.append("fondle pussy")
                    
                if "fondle ass" not in Options and (R_Obed < R_Inbt):
                        $ Options.append("fondle ass")
                    
                if "fondle breasts" not in Options and (R_Obed < R_Inbt):
                        $ Options.append("fondle breasts")
    # End filling options
    ...
    if Action != Options[Count2]: #If the action remains the same as it was.
            ...
            if R_Over == "bondage" or R_Over == "bondage cuffs" or R_Over == "armbinder":
                    ...
                    $ Line = "Rogue pulls out her dildo and draws it toward her pussy. " 
            elif Action == "fondle ass":
                    $ Line = "Rogue's hand slides behind her body, reaching toward her ass. " 
            elif Action == "dildo anal":
                    $ Line = "Rogue pulls out her dildo and reaches it behind her. "
            elif Action == "vibrator pussy":
...
label Rogue_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
    ...
    if Action == "hand":
                    if D20S <= 8 and (Trigger == "blow" or Trigger == "hand"): #This is a random bonus dialog
                        if Trigger == "blow": #If Kitty is blowing you                                    
                            $ Line = renpy.random.choice(["Rogue's fingers brush against " + ActiveGirl + "'s lips as they work",
                                    "Rogue and " + ActiveGirl + " pause for a second to briefly kiss", 
                                    "Rogue takes a turn to suck on the head before passing it back",
                                    "Rogue and " + ActiveGirl + " get into an alternating rhythm"]) 
                        elif Trigger == "hand":  #If Kitty is handying you
                            $ Line = renpy.random.choice(["Rogue's fingers brush against " + ActiveGirl + "'s as they work",
                                    "Rogue strokes " + ActiveGirl + "'s palm as she works", 
                                    "Rogue takes a turn to stroke a few times before passing it back",
                                    "Rogue and " + ActiveGirl + " get into an alternating rhythm"])   
                    else:                
                        if Trigger == "hand": #if another girl is also handy
                                $ Line = "Rogue also continues to stroke your cock"
    ...
    # end R_Hand Threeway                                //////////////////////////////////////////////////////////////////////////////
                    ...
                    if Speed > 2 and Trigger == "blow":
                        $ Line = "Since " + ActiveGirl + " is working so hard, Rogue settles for the occasional nibble or lick."
                        $ TempFocus += 5 if P_Focus > 60 else 3                      
                        $ TempLust += 2 if R_Lust > 80 else 1    
                    else:
                        if D20S <= 8 and (Trigger == "blow" or Trigger == "hand"): #This is a random bonus dialog
                            if Trigger == "blow": #If Kitty is blowing you
                                $ Line = renpy.random.choice(["Rogue's tongue brushes against " + ActiveGirl + "'s as they work",
                                        "Rogue and " + ActiveGirl + " pause for a second to briefly kiss", 
                                        "Rogue takes a turn to suck on the head before passing it back",
                                        "Rogue and " + ActiveGirl + " get into an alternating rhythm"]) 
                            elif Trigger == "hand": #If Kitty is handying you
                                $ Line = renpy.random.choice(["Rogue's tongue brushes against " + ActiveGirl + "'s hand as they work",
                                        "Rogue licks " + ActiveGirl + "'s palm as she works", 
                                        "Rogue takes a turn to stroke a few times before passing it back",
                                        "Rogue and " + ActiveGirl + " get into an alternating rhythm"])  
                            if ActiveGirl == "Kitty": 
                                    $ TempLust2 += 1 if K_LikeRogue >= 800 else 0      
                            elif ActiveGirl == "Emma":
                                    $ TempLust2 += 1 if E_LikeRogue >= 800 else 0                              
                        else:
                            if Trigger == "blow": #if another girl is also blowing
                                    $ Line = "Rogue also continues to lick your cock"
                            else: #if the other girl is doing something else
                                    $ Line = "Also, Rogue continues lick your cock"     
                        ...
                        $ R_Addict -= 2
    # end R_Blowjob Threeway                                //////////////////////////////////////////////////////////////////////////////
            
    elif Action == "fondle breasts":    
                        if Trigger2 == "fondle breasts" and Trigger != "lesbian": #if you're also fondling them,
                            $ Line = "Rogue also continues to fondle " + ActiveGirl + "'s breasts" 
                        else:
                            $ Line = "Rogue continues to fondle " + ActiveGirl + "'s breasts" 
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is fondling Kitty's breasts
                                $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                                $ TempLust2 += 5 if K_LikeRogue >= 800 else 2
                        elif ActiveGirl == "Emma": #If Rogue is fondling Emma's breasts
                                $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                                $ TempLust2 += 5 if E_LikeRogue >= 800 else 2
                        $ TempFocus += 1 
    # end R Fondle breasts Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        if Trigger2 == "fondle breasts" and Trigger != "lesbian": #if you're also fondling them,
                                $ Line = "Rogue also continues to suck " + ActiveGirl + "'s breasts" 
                        else:
                                $ Line = "Rogue continues to suck " + ActiveGirl + "'s breasts" 
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is sucking Kitty's breasts
                                $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                                $ TempLust2 += 4 if K_LikeRogue >= 800 else 2
                        elif ActiveGirl == "Emma": #If Rogue is fondling Emma's breasts
                                $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                                $ TempLust2 += 4 if E_LikeRogue >= 800 else 2
                        $ TempFocus += 1                      
    # end R Suck breasts Threeway                                //////////////////////////////////////////////////////////////////////////////
                        ...
                        if (Trigger == "fondle pussy" or Trigger2 == "fondle pussy") and Trigger != "lesbian": #if you're also fondling them,
                                $ Line = "Rogue also continues to fondle " + ActiveGirl + "'s pussy" 
                                ...
                                $ Line = "Rogue continues to fondle " + ActiveGirl + "'s pussy" 
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is stroking Kitty's pussy
                                $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                                $ TempLust2 += 5 if K_LikeRogue >= 800 else 3
                        elif ActiveGirl == "Emma": #If Rogue is fondling Emma's breasts
                                $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                                $ TempLust2 += 5 if E_LikeRogue >= 800 else 3
                        $ TempFocus += 1  
    ...
    # end R fondle pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if (Trigger == "lick pussy" or Trigger2 == "lick  pussy") and Trigger != "lesbian": #if you're also fondling them,
                            $ Line = "Rogue also continues to lick " + ActiveGirl + "'s pussy" 
                        else:    
                            $ Line = "Rogue continues to lick " + ActiveGirl + "'s pussy" 
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is stroking Kitty's pussy
                                $ TempLust += 3 if ApprovalCheck("Rogue", 600, "I") else 1  # Rogue's lust
                                $ TempLust2 += 7 if K_LikeRogue >= 800 else 4
                        elif ActiveGirl == "Emma": #If Rogue is fondling Emma's breasts
                                $ TempLust += 3 if ApprovalCheck("Rogue", 600, "I") else 1  # Rogue's lust
                                $ TempLust2 += 7 if E_LikeRogue >= 800 else 4
                        $ TempFocus += 3  
    ...
    # end R lick pussy Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if Trigger2 == "fondle ass" and Trigger != "lesbian": #if you're also fondling them,
                                $ Line = "Rogue also continues to fondle " + ActiveGirl + "'s ass" 
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is stroking Kitty's pussy
                                ...
                                $ TempLust2 += 3 if K_LikeRogue >= 800 else 1
                        elif ActiveGirl == "Emma": #If Rogue is fondling Emma's breasts
                                $ TempLust += 1 if ApprovalCheck("Rogue", 500, "I") else 0  # Rogue's lust
                                $ TempLust2 += 3 if E_LikeRogue >= 800 else 1
                        $ TempFocus += 1  
    # end R fondle ass Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if (Trigger == "insert ass" or Trigger2 == "insert ass") and Trigger != "lesbian": #if you're also fondling them,
                                $ Line = "Rogue also continues to stroke " + ActiveGirl + "'s ass" 
                        else:    
                                $ Line = "Rogue continues to stroke " + ActiveGirl + "'s ass" 
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is stroking Kitty's ass
                                $ TempLust += 2 if ApprovalCheck("Rogue", 700, "I") else 1  # Rogue's lust
                                $ TempLust2 += 5 if K_LikeRogue >= 800 else 3
                                if not K_Loose:
                                        $ TempLust2 -= 3
                        elif ActiveGirl == "Emma": #If Rogue is fondling Emma's breasts
    ...
    # end R insert ass Threeway                             /////////////////////////////////////////////////////////////////////////////
                        ...
                        if (Trigger == "lick ass" or Trigger2 == "lick ass") and Trigger != "lesbian": #if you're also fondling them,
                                $ Line = "Rogue also continues to lick " + ActiveGirl + "'s ass" 
                        else:    
                                $ Line = "Rogue continues to lick " + ActiveGirl + "'s ass" 
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is licking Kitty's ass
                                $ TempLust += 3 if ApprovalCheck("Rogue", 800, "I") else 1  # Rogue's lust
                                $ TempLust2 += 5 if K_LikeRogue >= 800 else 2
                                $ TempLust2 += 2 if R_Loose > 1 else 0
                        elif ActiveGirl == "Emma": #If Rogue is licking Emma's ass
                                $ TempLust += 3 if ApprovalCheck("Rogue", 800, "I") else 1  # Rogue's lust
    ...
    # end R lick ass Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        call Rogue_Self_Lines("T5",Trigger5) from _call_Rogue_Self_Lines_2  
                        $ TempLust = 0
    ...
    # end R Kissing Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        $ Line = "Rogue continues to watch the two of you" 
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is watching Kitty
                                $ TempLust += 1 if R_LikeKitty >= 600 else 0  # Rogue's lust
                                $ TempLust += 2 if R_LikeKitty >= 800 else 1  # Rogue's lust
                                $ TempLust2 += 1 if ApprovalCheck("Kitty", 500, "I") else 0
                                $ TempLust2 += 1 if ApprovalCheck("Kitty", 700, "I") else 0
                        elif ActiveGirl == "Emma": #If Rogue is watching Emma
    ...
    # for Threeway: Rogue_Threeway_Set("activity", 0, Trigger4, "Rogue")
            ...
            if State == "lesbian" or State == "threeway":
                ...
                if ActiveGirl == "Kitty":
                            ...
                            if ApprovalCheck("Rogue", 900, "I") and R_LikeKitty >= 900:
                                $ Options.append("lick ass")   
                elif ActiveGirl == "Emma":
                            if ApprovalCheck("Rogue", 800, "I") or R_LikeEmma >= 800:
                                $ Options.append("lick pussy")
                            if ApprovalCheck("Rogue", 900, "I") and R_LikeEmma >= 900:
                                $ Options.append("lick ass") 
#                            if "dildo" in R_Inventory: #add later once these systems are done
#                                $ Options.append("dildo pussy") 
#                                if R_Loose:
...
#                                $ Options.append("vibrator") 
            ...
            if Options[0] == "masturbation":
                        ...
                        if Trigger != "lesbian" and Trigger5 in ("kiss you", "kiss girl", "kiss both"):
                                ...
                                $ Trigger5 = 0 
                        call Rogue_Self_Lines("T5",Trigger5) from _call_Rogue_Self_Lines_3
            elif Options[0] == "hand":
...
#                        call RThreewayPussy_Launch #Launches position change
                        ...
                        if ActiveGirl == "Kitty": #If Rogue is stroking Kitty's pussy
                                $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                                $ TempLust2 += 5 if K_LikeRogue >= 800 else 3
                        elif ActiveGirl == "Emma": #If Rogue is fondling Emma's pussy
                                $ TempLust += 2 if ApprovalCheck("Rogue", 500, "I") else 1  # Rogue's lust
                                $ TempLust2 += 5 if E_LikeRogue >= 800 else 3
                        $ TempFocus += 2  
...
#                        call RThreewayPussy_Launch #Launches position change
                        ...
                        if "lesbian" not in R_RecentActions:
                                $ R_Les += 1
                                $ R_RecentActions.append("lesbian") 
                        if ActiveGirl == "Kitty": #If Rogue is licking Kitty's pussy
                                $ TempLust += 3 if ApprovalCheck("Rogue", 600, "I") else 1  # Rogue's lust
                                $ TempLust2 += 7 if K_LikeRogue >= 800 else 4
                        elif ActiveGirl == "Emma": #If Rogue is licking Emma's pussy
                                $ TempLust += 3 if ApprovalCheck("Rogue", 600, "I") else 1  # Rogue's lust
                                $ TempLust2 += 8 if E_LikeRogue >= 800 else 5
                        $ TempFocus += 3  
...
#                        call RThreewayPussy_Launch #Launches position change
                        ...
                        if "lesbian" not in R_RecentActions:
                                $ R_Les += 1
                                $ R_RecentActions.append("lesbian")                         
                        if ActiveGirl == "Kitty": #If Rogue is fondling Kitty's ass
                                $ TempLust += 1 if ApprovalCheck("Rogue", 400, "I") else 0  # Rogue's lust
                                $ TempLust2 += 3 if K_LikeRogue >= 600 else 1
                        elif ActiveGirl == "Emma": #If Rogue is fondling Emma's ass
                                $ TempLust += 1 if ApprovalCheck("Rogue", 400, "I") else 0  # Rogue's lust
                                $ TempLust2 += 3 if E_LikeRogue >= 600 else 2
                        $ TempFocus += 1  
...
#            elif Options[0] == "vibrator":    
                        ...
                        $ Line = Line + " Rogue is just watching the two of you intently"
                        $ Action = "watch"
                        if ActiveGirl == "Kitty": #If Rogue is watching Kitty
                                $ TempLust += 1 if R_LikeKitty >= 600 else 0  # Rogue's lust
                                $ TempLust += 2 if R_LikeKitty >= 800 else 1  # Rogue's lust
...
#    #Innocent
#        "You're so amazing, " + K_Petname + ". . ."
#        "You know how to push" + K_like + "every one of my buttons. . ."
#        "Heh. . .{i}somebody{/i} seems to like that."
#        "That's, like, {i}so{/i} good."
#    #Experienced
#        "This is {i}so{/i} hot, " + K_Petname + "."
...
#        "I've never wanted a guy like I want you, " + K_Petname + "."
#    #Specific
#        "I love the way it" + K_like + "feels in my hands." #hand 
#        "I hope you don't think I'm" + K_like + "a slut for saying this. . .but I love how you taste, " + K_Petname + "." #blow
#        "Oooohh. . .just like {i}that{/i}." #sex
#        "Please. . .go slow, 'kay? You feel so {i}big{/i}." #anal
#    #Both
#    #Innocent
#        "The more the merrier, right?"
#        "I never thought I'd ever do this with {i}two{/i} people."
#        "This is sooo naughty."
#        "Does doing this make me a bad girl?"
#    #Experienced
#        "I couldn't just let {i}her{/i} have all the fun."
#        "They say this is every guy's fantasy, right?"
#        "I think I saw this in a porn movie, once."
#        "Hope you slept good night night. We're gonna wear you out!"
#    #Specific
#        "Looks like he likes the way you do that." #hand
#        "Make sure you save some for {i}me{/i}!" #blow
#        "You two look {i}so{/i} sexy doing that." #sex
