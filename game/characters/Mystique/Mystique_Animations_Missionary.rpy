...
image Mystique_Sex_Body = LiveComposite(
        ...
        #     "E_Pierce == 'barbell'", +str(mystique_sex_loc)"/Mystique_Sex_Body_Barbell.png",
        #     "E_Pierce == 'ring'", +str(mystique_sex_loc)"/Mystique_Sex_Body_Ring.png",
            "True", +str(mystique_sex_loc)"/Mystique_Sex_Body.png",
            ),
        # (0,0), ConditionSwitch(                                                                                 #necklace
        #     "newgirl['Mystique'].Neck == 'black choker'", +str(mystique_sex_loc)"/Mystique_Sex_Choker_Black.png",
        #     "newgirl['Mystique'].Neck == 'choker'", +str(mystique_sex_loc)"/Mystique_Sex_Choker_White.png",
        #     "newgirl['Mystique'].Neck == 'NewX'", +str(mystique_sex_loc)"/Mystique_Sex_New_NeckX_White.png",
        #     "newgirl['Mystique'].Neck == 'black NewX'", +str(mystique_sex_loc)"/Mystique_Sex_New_NeckX_Black.png",
        #     "True", Null(),
        #     ),
        (350,-275), "Mystique_Head_Sex_2",  #check positioning (400,-300)
        # (0,0), ConditionSwitch(                                                                                 #gloves
        #     "E_Arms == 'black gloves'", +str(mystique_sex_loc)"/Mystique_Sex_Gloves_Black.png",
        #     "E_Arms == 'white gloves'", +str(mystique_sex_loc)"/Mystique_Sex_Gloves_White.png",
        #     "True", Null(),
        #     ),
        (0,0), ConditionSwitch(                                                                                 #tanktop
            "not newgirl['Mystique'].Chest", Null(),
        #     "E_Chest == 'cami'", +str(mystique_sex_loc)"/Mystique_Sex_Under_Cami.png",
        #     "E_Chest == 'sports bra'", +str(mystique_sex_loc)"/Mystique_Sex_Under_SportsBra.png",
        #     "E_Chest == 'bra'", +str(mystique_sex_loc)"/Mystique_Sex_Under_Bra.png",
            "newgirl['Mystique'].Chest == 'bra'", +str(mystique_sex_loc)"/Mystique_Sex_Under_Bra.png",
            # "E_Chest == 'black corset'", +str(mystique_sex_loc)"/Mystique_Sex_Corset_Black.png",
            # "E_Chest == 'corset'", +str(mystique_sex_loc)"/Mystique_Sex_Corset_White.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "newgirl['Mystique'].Water", +str(mystique_sex_loc)"/Mystique_Sex_Water_Body.png",
            "True", Null(),
            ),
        # (0,0), ConditionSwitch(                                                                                 #Overshirt
        #     "not newgirl['Mystique'].Over", Null(),
        #     "E_Over == 'pink top'", +str(mystique_sex_loc)"/Mystique_Sex_Over_PinkShirt.png",
        #     "E_Over == 'red shirt'", +str(mystique_sex_loc)"/Mystique_Sex_Over_RedShirt.png",
        #     "E_Over == 'towel'", +str(mystique_sex_loc)"/Mystique_Sex_Over_Towel.png",
        #     "True", Null(),
        #     ),
        (0,0),ConditionSwitch(                                                                                  #Outside Spunk
            "'belly' in newgirl['Mystique'].Spunk", +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Body.png",
            "True", Null(),
            ),
        )
...
#            ),
        ...
        (0,0), ConditionSwitch(                                                                         #Hair
            ...
            # "R_Hair == 'evo' and R_HairColor == 'black'", +str(rogue_sprite_loc)"/Rogue_hairBlack_evo.png",
            # "R_Hair == 'evo' and R_HairColor == 'blonde'", +str(rogue_sprite_loc)"/Rogue_hairBlonde_evo.png",
            "newgirl['Mystique'].Hair", +str(mystique_sex_loc)"/Mystique_sex_hair_front.png",
            "True", Null(),
            ),
...
image Mystique_Sex_Legs:
    LiveComposite(
        ...
        (1120,840),
        (0,0), ConditionSwitch(
            "newgirl['Mystique'].LegsUp", +str(mystique_sex_loc)"/Mystique_Sex_Legs_LegsUp.png",
            "True", +str(mystique_sex_loc)"/Mystique_Sex_Legs.png",
            ),                                                     #Legs Base
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "newgirl['Mystique'].LegsUp", Null(),
            "newgirl['Mystique'].Water", +str(mystique_sex_loc)"/Mystique_Sex_Water_Legs.png",
            "True", Null(),
            ),
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties if up
            ...
            # "newgirl['Mystique'].Panties == 'bikini'", +str(mystique_sex_loc)"/Mystique_Sex_Panty_BikiniBottom_White.png",
            # "newgirl['Mystique'].Panties == 'white panties'", +str(mystique_sex_loc)"/Mystique_Sex_Panty_White.png",
            # "newgirl['Mystique'].Panties == 'black panties'", +str(mystique_sex_loc)"/Mystique_Sex_Panty_Black.png",
            "True", Null(),
            ),
        # (0,0), ConditionSwitch(                                                                                 #Legs Layer
        #     "E_Upskirt", Null(),
        #     "E_Legs == 'capris' and newgirl['Mystique'].Wet > 1", +str(mystique_sex_loc)"/Mystique_Sex_Pants_Blue_Wet.png",
        #     "E_Legs == 'capris'", +str(mystique_sex_loc)"/Mystique_Sex_Pants_Blue.png",
        #     "E_Legs == 'black jeans' and newgirl['Mystique'].Wet > 1", +str(mystique_sex_loc)"/Mystique_Sex_Pants_BlacE_Wet.png",
        #     "E_Legs == 'black jeans'", +str(mystique_sex_loc)"/Mystique_Sex_Pants_Black.png",
        #     "E_Legs == 'shorts' and newgirl['Mystique'].Wet > 1", +str(mystique_sex_loc)"/Mystique_Sex_Shorts_Wet.png",
        #     "E_Legs == 'shorts'", +str(mystique_sex_loc)"/Mystique_Sex_Shorts.png",
        #     "E_Legs == 'yoga pants' and newgirl['Mystique'].Wet > 1", +str(mystique_sex_loc)"/Mystique_Sex_Pants_Yoga_Wet.png",
        #     "E_Legs == 'yoga pants'", +str(mystique_sex_loc)"/Mystique_Sex_Pants_Yoga.png",
        #     "True", Null(),
        #     ),
        # (0,0), ConditionSwitch(                                                                                 #Over Layer
        #     "E_Over == 'towel'", +str(mystique_sex_loc)"/Mystique_Sex_Towel_Legs.png",
        #     "True", Null(),
        #     ),
        (0,0),ConditionSwitch(                                                                                  #Outside Spunk
            "'belly' in newgirl['Mystique'].Spunk", +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Pelvis.png",
            "True", Null(),
            ),
        ...
        (0,0), ConditionSwitch(                                                         #Shows different lower body motion depending on events
            ...
            "P_Cock == 'anal' or P_Cock == 'in' or P_Cock == 'out'", AlphaMask("Mystique_Sex_Feet", +str(mystique_sex_loc)"/Mystique_Sex_FeetMask.png"),
...
image Mystique_Sex_Feet = LiveComposite(
        ...
        (1120,840),
        (0,0), ConditionSwitch(
            "newgirl['Mystique'].LegsUp", +str(mystique_sex_loc)"/Mystique_Sex_Feet_LegsUp.png",
            "True", +str(mystique_sex_loc)"/Mystique_Sex_Feet.png",
            ),
        (0,0), ConditionSwitch(                                                                                 #Wet look
            "newgirl['Mystique'].Water", +str(mystique_sex_loc)"/Mystique_Sex_Water_Feet.png",
            "True", Null(),
            ),
        # (0,0), ConditionSwitch(                                                                                 #Legs Layer
        #     "E_Upskirt", Null(),
        #     "E_Legs == 'capris'", +str(mystique_sex_loc)"/Mystique_Sex_Feet_Blue.png",
        #     "E_Legs == 'black jeans'", +str(mystique_sex_loc)"/Mystique_Sex_Feet_Black.png",
        #     "E_Legs == 'yoga pants'", +str(mystique_sex_loc)"/Mystique_Sex_Feet_Yoga.png",
        #     "True", Null(),
        #     ),
        )
...
image Mystique_Pussy_Fucking0:
    ...
    contains:
            ...
            +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Open.png"
    contains:
            # pubes
            ConditionSwitch(
                "not newgirl['Mystique'].Pubes", Null(),
                "True", +str(mystique_sex_loc)"/Mystique_Sex_Pubes_Open.png",
                ),
    contains:
...
image Mystique_Pussy_Fucking2:
    ...
    contains:
            # The background plate of her pussy
            +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Fucking.png"
    contains:
            # pubes
            ConditionSwitch(
                "not newgirl['Mystique'].Pubes", Null(),
                "True", +str(mystique_sex_loc)"/Mystique_Sex_Pubes_Fucking.png",
                ),
    contains:
            # The animation of Zero's moving penis, masked by her pussy shape
...
image Mystique_Pussy_Fucking_Mask:
        ...
        contains:
            +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Mask.png"
...
image Mystique_Pussy_Spunk_Heading:
    +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Puss_Over.png"
    anchor (0.5,0.5)
    pos (0.5,0.5)
    xzoom 0.8
...
image Mystique_Sex_Pussy:
    ...
    contains:
            # The background plate of her pussy
            ConditionSwitch(
                "P_Sprite and P_Cock == 'in' and Speed >= 2", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Fucking.png",
                "P_Sprite and P_Cock == 'in' and Speed", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Open.png",
                "P_Sprite and P_Cock == 'in'", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Closed.png",
                "Trigger == 'lick pussy'", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Open.png",
                "True", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Closed.png",
                )
    contains:
            # The background plate of her pussy
            ConditionSwitch(
                "not newgirl['Mystique'].Wet", Null(),
                "P_Sprite and P_Cock == 'in' and Speed >= 2", +str(mystique_sex_loc)"/Mystique_Sex_WetPussy_F.png",
                "True", +str(mystique_sex_loc)"/Mystique_Sex_WetPussy_C.png",
                )
    # contains:
    #         #ring piercing
    #         ConditionSwitch(
    #             "E_Pierce != 'ring'", Null(),
    #             "not P_Sprite or P_Cock != 'in' or Speed <= 1", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Ring.png",
    #             "True", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_RingF.png",
    #             )
    # contains:
    #         #barbell piercing
    #         ConditionSwitch(
    #             "E_Pierce != 'barbell'", Null(),
    #             "not P_Sprite or P_Cock != 'in' or Speed <= 1", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_Barbell.png",
    #             "True", +str(mystique_sex_loc)"/Mystique_Sex_Pussy_BarbellF.png",
    #             )
    contains:
            # pubes
            ConditionSwitch(
                "not newgirl['Mystique'].Pubes", Null(),
                "P_Sprite and P_Cock == 'in' and Speed >= 2", +str(mystique_sex_loc)"/Mystique_Sex_Pubes_Fucking.png",
                "P_Sprite and P_Cock == 'in' and Speed", +str(mystique_sex_loc)"/Mystique_Sex_Pubes_Open.png",
                "P_Sprite and P_Cock == 'in'", +str(mystique_sex_loc)"/Mystique_Sex_Pubes_Closed.png",
                "Trigger == 'lick pussy'", +str(mystique_sex_loc)"/Mystique_Sex_Pubes_Open.png",
                "True", +str(mystique_sex_loc)"/Mystique_Sex_Pubes_Closed.png",
                )
    contains:
            #Spunk under penis
            ConditionSwitch(
                "'in' in newgirl['Mystique'].Spunk", +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Puss_Under.png",
                "True", Null(),
                )
    contains:
            # The animation of Zero's moving penis, masked by her pussy shape
    ...
    contains:
            ...
            ConditionSwitch(
                ...
                "True", +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Puss_Over.png",
                )
...
image Mystique_Sex_Anus:
    contains:
            ...
            ConditionSwitch(
            "P_Sprite and P_Cock == 'anal' and Speed >= 3", +str(mystique_sex_loc)"/Mystique_Sex_Hole_Open.png",
            "P_Sprite and P_Cock == 'anal' and Speed >= 2", +str(mystique_sex_loc)"/Mystique_Sex_Hole_Open.png",
            "P_Sprite and P_Cock == 'anal' and Speed", "Mystique_Anal_Heading",
            "P_Sprite and P_Cock == 'anal'", "Mystique_Anal_Tip",
            "E_Loose", +str(mystique_sex_loc)"/Mystique_Sex_Hole_Loose.png",
            "True", +str(mystique_sex_loc)"/Mystique_Sex_Hole_Tight.png",
            )
    contains:
            #Spunk under penis
            ConditionSwitch(
                "'anal' not in newgirl['Mystique'].Spunk", Null(),
                "P_Sprite and P_Cock != 'anal' and Speed >= 1", +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Anal_Under.png",
                "P_Sprite and P_Cock != 'anal' and Speed == 1", "Mystique_Anal_Spunk_Heading_Under",
                "True", +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Anal_Closed.png",
                )
    contains:
    ...
    contains:
            ...
            ConditionSwitch(
                ...
                "True", +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Anal_Over.png",
                )
...
image Mystique_Anal_Fucking2:
    ...
    contains:
            # The background plate of her pussy
            +str(mystique_sex_loc)"/Mystique_Sex_Hole_Open.png"
    contains:
            # The animation of Zero's moving penis, masked by her pussy shape
...
image Mystique_Anal_Fucking_Mask:
        #This is the mask image for Mystique's wide open pussy
        contains:
            +str(mystique_sex_loc)"/Mystique_Sex_Hole_Mask.png"
...
image Mystique_Anal_Spunk_Heading_Over:
    +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Anal_Over.png"
    anchor (0.5,0.5)
    pos (0.5,0.5)
    xzoom 0.8
    block:
...
image Mystique_Anal_Spunk_Heading_Under:
    +str(mystique_sex_loc)"/Mystique_Sex_Spunk_Anal_Under.png"
    anchor (0.5,0.5)
    pos (0.5,0.5)
    xzoom 0.6
    block:
