...
#            "not L_Hair", Null(),
#            "L_Hair == 'wet' or L_Water", +str(laura_sprite_loc)"/Laura_Sprite_Head_HairBackWet.png",
#            "True", Null(),
#            ),
        (0,0), ConditionSwitch(
            #hair back
            "not newgirl['Laura'].Hair", Null(),
#            "L_Hair == 'wet' or L_Water", +str(laura_sprite_loc)"/Laura_Sprite_HairbackWet.png",
...
#            "newgirl['Laura'].Panties == 'sports panties'", +str(laura_sprite_loc)"/Laura_Sprite_Panties_Sports_DownBack.png",
#            "True", +str(laura_sprite_loc)"/Laura_Sprite_Panties_DownBack.png",
#            ),
        (0,0), ConditionSwitch(
            #backside of arms
            "newgirl['Laura'].Girl_Arms == 2", +str(laura_sprite_loc)"/Laura_Sprite_Arm_Back2.png",
            "True", +str(laura_sprite_loc)"/Laura_Sprite_Arm_Back1.png", #if newgirl['Laura'].Arms == 1
            ),
#        (0,0), ConditionSwitch(
#            #arms wristband
#            "newgirl['Laura'].Arms == 'wrists'", +str(laura_sprite_loc)"/Laura_Sprite_Wrist_Right.png", # one hand up
#            "True", Null(),
#            ),
        #body
        (0,0), +str(laura_sprite_loc)"/Laura_Sprite_Body.png",
        (0,0), ConditionSwitch(
            #pubes
            "newgirl['Laura'].Pubes", +str(laura_sprite_loc)"/Laura_Sprite_Pubes.png",
            "True", Null(),
            ),
#        (0,0), ConditionSwitch(
...
#            "newgirl['Laura'].Pierce == 'barbell'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Pussy_Barbell.png",
#            "newgirl['Laura'].Pierce == 'ring'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Pussy_Ring.png",
#            "True", Null(),
#            ),
#        (0,0), ConditionSwitch(
#            #Water effect
#            "newgirl['Laura'].Water", +str(laura_sprite_loc)"/Laura_Sprite_Water_Body.png",
#            "True", Null(),
#            ),
        (0,0), ConditionSwitch(
            #panties
...
#                            "newgirl['Laura'].Panties == 'black panties'", +str(laura_sprite_loc)"/Laura_Sprite_Panties_Leather_Down.png",
#                            "True", Null(),
#                            ),
#                    "True", Null(),
#                    ),
...
#                        #if she's not wet
#                        "True", +str(laura_sprite_loc)"/Laura_Sprite_Panties_Leather_Wet.png",
#                        ),
                    "True", ConditionSwitch(
                        #if she's wet
                        "True", +str(laura_sprite_loc)"/Laura_Sprite_Panties_Leather.png",
                        ),
                    ),
            ),
        (0,0), ConditionSwitch(
            ...
            "newgirl['Laura'].Upskirt", ConditionSwitch(
                        ...
                        "newgirl['Laura'].Legs == 'skirt'", +str(laura_sprite_loc)"/Laura_Sprite_SkirtUp.png",
                        "True", Null(),
                        ),
            "True", ConditionSwitch(
                    ...
                    "newgirl['Laura'].Wet", ConditionSwitch(
                        #if she's not wet
                        "newgirl['Laura'].Legs == 'leather pants'", +str(laura_sprite_loc)"/Laura_Sprite_Pants_Leather.png",
                        "newgirl['Laura'].Legs == 'mesh pants'", +str(laura_sprite_loc)"/Laura_Sprite_Pants_Mesh.png",
                        "newgirl['Laura'].Legs == 'yoga pants'", +str(laura_sprite_loc)"/Laura_Sprite_Pants_YogaWet.png",
                        "newgirl['Laura'].Legs == 'skirt'", +str(laura_sprite_loc)"/Laura_Sprite_Skirt.png",
                        "True", Null(),
                        ),
                    "True", ConditionSwitch(
                        #if she's wet
                        "newgirl['Laura'].Legs == 'leather pants'", +str(laura_sprite_loc)"/Laura_Sprite_Pants_Leather.png",
                        "newgirl['Laura'].Legs == 'mesh pants'", +str(laura_sprite_loc)"/Laura_Sprite_Pants_Mesh.png",
                        "newgirl['Laura'].Legs == 'yoga pants'", +str(laura_sprite_loc)"/Laura_Sprite_Pants_Yoga.png",
                        "newgirl['Laura'].Legs == 'skirt'", +str(laura_sprite_loc)"/Laura_Sprite_Skirt.png",
                        "True", Null(),
                        ),
                    ),
...
#                    "newgirl['Laura'].Legs and not newgirl['Laura'].Upskirt", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Pussy_BarOut.png",
#                    "newgirl['Laura'].Panties and not newgirl['Laura'].PantiesDown", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Pussy_BarOut.png",
#                    "True", Null(),
#                    ),
#            "newgirl['Laura'].Pierce == 'ring'", ConditionSwitch(
#                    #if it's the ring pericings
#                    "newgirl['Laura'].Legs and not newgirl['Laura'].Upskirt", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Pussy_RingOut.png",
#                    "newgirl['Laura'].Panties and not newgirl['Laura'].PantiesDown", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Pussy_RingOut.png",
#                    "True", Null(),
#                    ),
#            "True", Null(),
#            ),
...
#            "newgirl['Laura'].Legs", +str(laura_sprite_loc)"/Laura_Sprite_Wet.png",
#            "newgirl['Laura'].Wet == 1", +str(laura_sprite_loc)"/Laura_Sprite_Wet.png",
#            "True", +str(laura_sprite_loc)"/Laura_Sprite_Wet.png",       #newgirl['Laura'].Wet >1
#            ),
#        (0,0), ConditionSwitch(
#            #pussy spunk
#            "newgirl['Laura'].Legs", Null(),
#            "'pussy' in newgirl['Laura'].Spunk", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_Pussy.png",
#            "True", Null(),
#            ),
#        (0,0), ConditionSwitch(
#            #belly spunk
#            "'belly' in newgirl['Laura'].Spunk", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_Belly.png",
#            "True", Null(),
#            ),

        (0,0), ConditionSwitch(
            #arms midlayer
            "newgirl['Laura'].Girl_Arms == 2", +str(laura_sprite_loc)"/Laura_Sprite_Arm_Mid2.png",         # one hand up
            "True", +str(laura_sprite_loc)"/Laura_Sprite_Arm_Mid1.png", #if newgirl['Laura'].Arms == 1   # Crossed
            ),
#        (0,0), ConditionSwitch(
#            #Water effect on arms
#            "not newgirl['Laura'].Water", Null(),
#            "newgirl['Laura'].Girl_Arms == 1", +str(laura_sprite_loc)"/Laura_Sprite_Water_Arms1.png",
#            "True", +str(laura_sprite_loc)"/Laura_Sprite_Water_Arms2.png", #if newgirl['Laura'].Arms == 1
#            ),
        (0,0), ConditionSwitch(
            #arms wristband
            "newgirl['Laura'].Arms == 'wrists' and newgirl['Laura'].Girl_Arms == 2", +str(laura_sprite_loc)"/Laura_Sprite_Wrist2.png", # one hand up
            "newgirl['Laura'].Arms == 'wrists'", +str(laura_sprite_loc)"/Laura_Sprite_Wrist1.png", # one hand up
            "True", Null(),
            ),

        # tits
        (0,0), +str(laura_sprite_loc)"/Laura_Sprite_Tits.png",
#        (0,0), ConditionSwitch(
#            #nude peircings
...
#            "newgirl['Laura'].Pierce == 'barbell'", ConditionSwitch(
#                    #if it's the barbell pericings
#                    "newgirl['Laura'].Girl_Arms == 1", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_Barbell.png",
#                    "newgirl['Laura'].Chest == 'corset'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_Barbell.png",
#                    "newgirl['Laura'].Chest == 'lace bra'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_Barbell.png",
#                    "newgirl['Laura'].Chest == 'sports bra'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_Barbell.png",
#                    "True", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Down_Barbell.png",
#                    ),
#            "newgirl['Laura'].Pierce == 'ring'", ConditionSwitch(
#                    #if it's the ring pericings
#                    "newgirl['Laura'].Girl_Arms == 1", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_Ring.png",
#                    "newgirl['Laura'].Chest == 'corset'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_Ring.png",
#                    "newgirl['Laura'].Chest == 'lace bra'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_Ring.png",
#                    "newgirl['Laura'].Chest == 'sports bra'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_Ring.png",
#                    "True", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Down_Ring.png",
#                    ),
#            "True", Null(),
#            ),
        ...
        (0,0), ConditionSwitch(
            #neck
            "newgirl['Laura'].Neck == 'leash choker'", +str(laura_sprite_loc)"/Laura_Sprite_Neck_Leash.png",
            "True", Null(),
            ),
#        (0,0), ConditionSwitch(
#            #Water effect
#            "not newgirl['Laura'].Water", Null(),
#            "newgirl['Laura'].Girl_Arms == 1 or newgirl['Laura'].Chest == 'corset'", +str(laura_sprite_loc)"/Laura_Sprite_Water_TitsUp.png",
#            "True", +str(laura_sprite_loc)"/Laura_Sprite_Water_TitsDown.png", #if newgirl['Laura'].Arms == 1
#            ),
        (0,0), ConditionSwitch(
            #Chest layer
            "newgirl['Laura'].Chest == 'leather bra'", +str(laura_sprite_loc)"/Laura_Sprite_Bra_Leather.png",
            "newgirl['Laura'].Chest == 'sports bra'", +str(laura_sprite_loc)"/Laura_Sprite_Bra_Sports.png",
            "newgirl['Laura'].Chest == 'lace bra'", +str(laura_sprite_loc)"/Laura_Sprite_Bra_Lace.png",
            "True", Null(),
            ),
#        (0,0), ConditionSwitch(
#            #clothed peircings
...
#            "newgirl['Laura'].Pierce == 'barbell'", ConditionSwitch(
#                    #if it's the barbell pericings
#                    "newgirl['Laura'].Girl_Arms == 1", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_BarOut.png",
#                    "newgirl['Laura'].Chest == 'corset'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_BarOut.png",
#                    "newgirl['Laura'].Chest == 'lace bra'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_BarOut.png",
#                    "newgirl['Laura'].Chest == 'sports bra'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_BarOut.png",
#                    "True", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Down_BarOut.png",
#                    ),
#            "newgirl['Laura'].Pierce == 'ring'", ConditionSwitch(
#                    #if it's the ring pericings
#                    "newgirl['Laura'].Girl_Arms == 1", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_RingOut.png",
#                    "newgirl['Laura'].Chest == 'corset'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_RingOut.png",
#                    "newgirl['Laura'].Chest == 'lace bra'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_RingOut.png",
#                    "newgirl['Laura'].Chest == 'sports bra'", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Up_RingOut.png",
#                    "True", +str(laura_sprite_loc)"/Laura_Sprite_Pierce_Down_RingOut.png",
#                    ),
#            "True", Null(),
#            ),
#        (0,0), ConditionSwitch(
...
#                    #if it's the barbell pericings
#                    "newgirl['Laura'].Girl_Arms == 1", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_TitsU.png",
#                    "newgirl['Laura'].Chest == 'corset'", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_TitsU.png",
#                    "newgirl['Laura'].Chest == 'lace bra'", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_TitsU.png",
#                    "newgirl['Laura'].Chest == 'sports bra'", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_TitsU.png",
#                    "True", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_TitsD.png",
#                    ),
#            "True", Null(),
#            ),
        ...
        (0,0), ConditionSwitch(
            #arms midlayer
            "newgirl['Laura'].Girl_Arms == 2", +str(laura_sprite_loc)"/Laura_Sprite_Arm_Left2.png", # one hand up
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
            #arms wristband
            "newgirl['Laura'].Girl_Arms == 2 and newgirl['Laura'].Arms == 'wrists'", +str(laura_sprite_loc)"/Laura_Sprite_Wrist_Left2.png", # one hand up
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
            #claws
            "newgirl['Laura'].Girl_Arms == 2 and newgirl['Laura'].Claws", +str(laura_sprite_loc)"/Laura_Sprite_Claws2.png", # one hand up
            "True", Null(),
            ),
...
#            "'mouth' in newgirl['Laura'].Spunk", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_HandM.png",
#            "True", +str(laura_sprite_loc)"/Laura_Sprite_Spunk_Hand.png",
#            ),
#        (0,0), ConditionSwitch(                                                                         #Props
#            "not newgirl['Laura'].Held or newgirl['Laura'].Girl_Arms != 2", Null(),
#            "newgirl['Laura'].Girl_Arms == 2 and newgirl['Laura'].Held == 'phone'", +str(laura_sprite_loc)"/Laura_held_phone.png",
#            "newgirl['Laura'].Girl_Arms == 2 and newgirl['Laura'].Held == 'dildo'", +str(laura_sprite_loc)"/Laura_held_dildo.png",
#            "newgirl['Laura'].Girl_Arms == 2 and newgirl['Laura'].Held == 'vibrator'", +str(laura_sprite_loc)"/Laura_held_vibrator.png",
#            "newgirl['Laura'].Girl_Arms == 2 and newgirl['Laura'].Held == 'panties'", +str(laura_sprite_loc)"/Laura_held_panties.png",
#            "True", Null(),
#            ),
        (0,0), ConditionSwitch(
...
image Laura_Sprite_HairBack:
    +str(laura_sprite_loc)"/Laura_Sprite_Hair_Long_Under.png"
    anchor (0.6, 0.0)
    zoom .5
...
image Laura_Sprite_Head:
    LiveComposite(
        ...
        (0,0), ConditionSwitch(
                ...
                "newgirl['Laura'].Blush == 2", +str(laura_sprite_loc)"/Laura_Sprite_Head_Blush2.png",
                "newgirl['Laura'].Blush", +str(laura_sprite_loc)"/Laura_Sprite_Head_Blush.png",
                "True", +str(laura_sprite_loc)"/Laura_Sprite_Head.png",
                ),
        (0,0), ConditionSwitch(                                                                         #Mouths
            "newgirl['Laura'].Mouth == 'normal'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Normal.png",
            "newgirl['Laura'].Mouth == 'lipbite'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Lipbite.png",
            "newgirl['Laura'].Mouth == 'sucking'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Sucking.png",
            "newgirl['Laura'].Mouth == 'kiss'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Kiss.png",
            "newgirl['Laura'].Mouth == 'sad'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Sad.png",
            "newgirl['Laura'].Mouth == 'smile'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Smile.png",
            "newgirl['Laura'].Mouth == 'surprised'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Surprised.png",
            "newgirl['Laura'].Mouth == 'tongue'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Tongue.png",
            "newgirl['Laura'].Mouth == 'grimace'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Smile.png",
            "newgirl['Laura'].Mouth == 'smirk'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Smirk.png",
#            "newgirl['Laura'].Mouth == 'smirk'", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Normal.png",
            "True", +str(laura_sprite_loc)"/Laura_Sprite_Mouth_Normal.png",
            ),

#        (0,0), ConditionSwitch(                                                                         #Mouth spunk
#            "'mouth' not in newgirl['Laura'].Spunk", Null(),
#            "newgirl['Laura'].Mouth == 'surprised'", +str(laura_sprite_loc)"/Laura_Sprite_Head_Spunk_MouthOpen.png",
#            "newgirl['Laura'].Mouth == 'tongue'", +str(laura_sprite_loc)"/Laura_Sprite_Head_Spunk_MouthTongue.png",
#            "True", +str(laura_sprite_loc)"/Laura_Sprite_Head_Spunk_Mouth.png",
#            ),

        (0,0), ConditionSwitch(
            #brows
            "newgirl['Laura'].Blush >= 2", ConditionSwitch(
                    "newgirl['Laura'].Brows == 'normal'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Normal_B.png",
                    "newgirl['Laura'].Brows == 'angry'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Angry_B.png",
                    "newgirl['Laura'].Brows == 'sad'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Sad_B.png",
                    "newgirl['Laura'].Brows == 'surprised'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Surprised_B.png",
                    "newgirl['Laura'].Brows == 'confused'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Confused_B.png",
                    "True", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Normal_B.png",
                    ),
            "True", ConditionSwitch(
                    "newgirl['Laura'].Brows == 'normal'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Normal.png",
                    "newgirl['Laura'].Brows == 'angry'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Angry.png",
                    "newgirl['Laura'].Brows == 'sad'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Sad.png",
                    "newgirl['Laura'].Brows == 'surprised'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Surprised.png",
                    "newgirl['Laura'].Brows == 'confused'", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Confused.png",
                    "True", +str(laura_sprite_loc)"/Laura_Sprite_Brows_Normal.png",
                    ),
            ),
        (0,0), "Laura Blink",     #Eyes
#        (0,0), ConditionSwitch(                                                                         #facial spunk
#            "'facial' in newgirl['Laura'].Spunk", +str(laura_sprite_loc)"/Laura_Sprite_Head_Spunk_Face.png",
#            "True", Null(),
#            ),
        (0,0), ConditionSwitch(
            #Hair
            "not newgirl['Laura'].Hair", Null(),
#            "newgirl['Laura'].Hair == 'wet' or newgirl['Laura'].Water", +str(laura_sprite_loc)"/Laura_Sprite_Head_HairWet.png",
            "newgirl['Laura'].Hair", +str(laura_sprite_loc)"/Laura_Sprite_Hair_Long_Over.png",
            "True", Null(),
            ),
#        (0,0), ConditionSwitch(                                                                         #Hair Water
#            "not newgirl['Laura'].Water", Null(),
#            "newgirl['Laura'].Hair == 'wet'", +str(laura_sprite_loc)"/Laura_Sprite_Head_Water.png",
#            "True", +str(laura_sprite_loc)"/Laura_Sprite_Head_Water.png",
#            ),
#        (0,0), ConditionSwitch(                                                                         #hair spunk
#            "'hair' in newgirl['Laura'].Spunk and (newgirl['Laura'].Hair == 'wet' or newgirl['Laura'].Water)", +str(laura_sprite_loc)"/Laura_Sprite_Head_Spunk_HairWet.png",
#            "'hair' in newgirl['Laura'].Spunk", +str(laura_sprite_loc)"/Laura_Sprite_Head_Spunk_HairWave.png",
#            "True", Null(),
#            ),
        )
    anchor (0.6, 0.0)
...
image Laura Blink:
    ConditionSwitch(
    "newgirl['Laura'].Eyes == 'sexy'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Squint.png",
    "newgirl['Laura'].Eyes == 'side'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Side.png",
    "newgirl['Laura'].Eyes == 'surprised'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Surprised.png",
    "newgirl['Laura'].Eyes == 'normal'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Normal.png",
    "newgirl['Laura'].Eyes == 'stunned'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Stunned.png",
    "newgirl['Laura'].Eyes == 'down'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Down.png",
    "newgirl['Laura'].Eyes == 'closed'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Closed.png",
    "newgirl['Laura'].Eyes == 'leftside'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Leftside.png",
    "newgirl['Laura'].Eyes == 'manic'", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Normal.png",
    "newgirl['Laura'].Eyes == 'squint'", "Laura_Squint",
    "True", +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Normal.png",
    ),
    choice:
        3.5
    choice:
    ...
    choice:
        3
    +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Closed.png"
    .25
    repeat

image Laura_Squint:
    +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Normal.png"
    choice:
        3.5
    choice:
        3.25
    choice:
        3
    +str(laura_sprite_loc)"/Laura_Sprite_Eyes_Squint.png"
    .25
    repeat
# End Laura Sprite / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / / /
