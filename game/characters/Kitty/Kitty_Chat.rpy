...
label Kitty_Chat:
    call KittyFace from _call_KittyFace_1206    
    call Shift_Focus("Kitty") from _call_Shift_Focus_287
    call Change_Focus("Kitty") from _call_Change_Focus_12
    ...
    menu:
                    ...
                    if Room_Full():
                        ...
                        menu:
                            ...
                            "Rogue" if R_Loc == bg_current:
                                call Rogue_Dismissed from _call_Rogue_Dismissed_3
                            "Emma" if E_Loc == bg_current:
                                call Emma_Dismissed from _call_Emma_Dismissed_3
                    else:
                        call Kitty_Summon from _call_Kitty_Summon
        ...
        "Send a dick pic." if K_Loc != bg_current:
                    ...
                    if K_SEXP < 10:
                            ...
                            #$ K_Eyes = "down"
                            ch_k "Wtf dude."  
                            call KittyFace("angry", 1) from _call_KittyFace_1207 
                            ...
                            call Kitty_Sent_Selfie(1) from _call_Kitty_Sent_Selfie_8
                            $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 70, 8)
                    elif ApprovalCheck("Kitty", 500, "I", TabM=2):
                            call KittyFace("surprised", 1) from _call_KittyFace_1208 
                            #$ K_Eyes = "down"
                            #"Kitty glances at it, but just smiles in amusement."
                            ch_k "wow"            
                            call Kitty_Sent_Selfie from _call_Kitty_Sent_Selfie_9
        ...
        "Ask Kitty to leave" if K_Loc == bg_current:
                    call Kitty_Dismissed from _call_Kitty_Dismissed_3    
                    return
        
        "Flirt with her." if not K_Chat[5]:
                    call Kitty_Flirt from _call_Kitty_Flirt               
        ...
        "Show me the plug." if K_Plugged:
                    ...
                    if ApprovalCheck("Kitty", 1450, TabM = 3) or ApprovalCheck("Kitty", 800, "O") or "exhibitionist" in K_Traits: # 145, 160, 175, Taboo -160(355)
                        call KittyFaceSpecial("sexy",1) from _call_KittyFaceSpecial_5
                        ch_k "Ok [K_Petname]."
                        call Kitty_Doggy_Launch("plug") from _call_Kitty_Doggy_Launch_1
                        ...
                        if K_Legs:
                            ...
                            call Kitty_Show_Plug from _call_Kitty_Show_Plug
                            $ K_PantiesDown = 0
                            pause .1
                            #if Temp_K_Hose:
                            #    $ K_Hose = Temp_K_Hose
                        ...
                        #    pause
                            ...
                            ch_k "There, you happy?"
                            call Kitty_Show_Plug from _call_Kitty_Show_Plug_1
                            pause


                        call Kitty_Doggy_Reset from _call_Kitty_Doggy_Reset_1 
                    else:
                        if Taboo:
        ...
        "Take Rogue's clothes off" if R_Loc == bg_current:
                    ...
                    if ApprovalCheck("Kitty", 600):
                        call KittyFace("sly",0) from _call_KittyFace_1209
                        ...
                        if R_Panties == "swimsuit1" or R_Panties == "swimsuit2":
                            ...
                            call RogueFace("surprised", 2) from _call_RogueFace_1398
                            "Kitty grabs Rogue's swimsuit and phase them out of Rogue's body using her powers."
                            call Rogue_First_Bottomless(1) from _call_Rogue_First_Bottomless_34 
                            ...
                            menu:
                                ...
                                "Her top" if R_Over or R_Chest:    
                                    ...
                                    call RogueFace("surprised", 2) from _call_RogueFace_1399
                                ...
                                "Her bottoms" if R_Legs or R_Panties or R_Hose:
                                    ...
                                    call RogueFace("surprised", 2) from _call_RogueFace_1400
                                    "Kitty grabs Rogue's clothes and phase them out of Rogue's body using her powers."
                                    call Rogue_First_Bottomless(1) from _call_Rogue_First_Bottomless_35 
                        ...
                        if not Taboo: #no taboo
                            if "exhibitionist" in R_Traits:
                                ...
                                call RogueFace("sexy", 1) from _call_RogueFace_1401
                                ...
                                call RogueFace("smile",1) from _call_RogueFace_1402
                            elif ApprovalCheck("Rogue", 850, "L"):
                                call RogueFace("sexy", 1) from _call_RogueFace_1403
                                ch_r "Oh, naughty!"
                                ch_r "You could have just asked, you know. . ."
                            elif ApprovalCheck("Rogue", 700, "L"):
                                call RogueFace("sexy", 1) from _call_RogueFace_1404
                                ch_r "[R_Petname], Kitty! A little warning!"
                            elif ApprovalCheck("Rogue", 600, "L"):
                                call RogueFace("bemused", 1) from _call_RogueFace_1405
                                ...
                                call RogueFace("angry", 1) from _call_RogueFace_1406
                                ...
                                call RogueFace("angry", 1) from _call_RogueFace_1407
                                $ R_RecentActions.append("angry")
                                $ R_DailyActions.append("angry")
                                call AllReset("Rogue") from _call_AllReset_5
                                call Remove_Girl("Rogue") from _call_Remove_Girl_96
                                call RogueOutfit from _call_RogueOutfit_75
                            ...
                            if "exhibitionist" in R_Traits:
                                ...
                                call RogueFace("angry", 1) from _call_RogueFace_1414
                                $ R_RecentActions.append("angry")
                                $ R_DailyActions.append("angry")
                                call AllReset("Rogue") from _call_AllReset_6
                                call Remove_Girl("Rogue") from _call_Remove_Girl_97
                                call RogueOutfit from _call_RogueOutfit_76

                            $ R_Obed = Statupdate("Rogue", "Obed", R_Obed, 80, 7)             
                            $ R_Inbt = Statupdate("Rogue", "Inbt", R_Inbt, 30, 4)           
                            $ R_Inbt = Statupdate("Rogue", "Inbt", R_Inbt, 80, 4)  
                            call Rogue_First_Bottomless(1) from _call_Rogue_First_Bottomless_36                 
                        $ R_Lust = Statupdate("Rogue", "Lust", R_Lust, 60, 1) 
                        #if "exhibitionist" in R_Traits:
                        #End Flip her Skirt   
                        #call AllReset("Rogue")
                        call RogueOutfit from _call_RogueOutfit_77
                        call KittyFace("smile",0) from _call_KittyFace_1210
        ...
        "Sex Menu" if K_Loc == bg_current:
                    ...
                    if "angry" in K_RecentActions:  
                        ...
                        call KittyFace("sexy") from _call_KittyFace_1211
                        ch_k "Mmmm, ok, [K_Petname]."
                        call Kitty_SexMenu from _call_Kitty_SexMenu_5
                        return
                    elif ApprovalCheck("Kitty", 400, "OI"):
                        ch_k "Yes, [K_Petname]."
                        call Kitty_SexMenu from _call_Kitty_SexMenu_6
                        return
                    else:
                        ch_k "No thanks, [K_Petname]."          
                          
        "I just wanted to talk. . .":
                    call Kitty_Chitchat from _call_Kitty_Chitchat   
                    
        "Kitty's settings":
                    ch_p "Let's talk about you."
                    call Kitty_Settings from _call_Kitty_Settings   
        ...
        "Relationship status":
                    ...
                    if "relationship" in K_DailyActions:
                        ...
                        call Kitty_Relationship from _call_Kitty_Relationship
                    else:
        ...
        "Gifts" if K_Loc == bg_current:
                    ...
                    call Kitty_Gifts from _call_Kitty_Gifts
        ...
        "Disband party" if "Kitty" in Party: 
                    ...
                    $ Party.remove("Kitty")       
                    call Kitty_Schedule(0) from _call_Kitty_Schedule_3
                    if K_Loc == bg_current:
                        ch_k "Good to know, but I'm[K_like] fine here."
                    else:
                        ch_k "Cool, later."
                        call Set_The_Scene from _call_Set_The_Scene_191   
                    return
                
        
        "Date" if Current_Time == "Evening":
                    ch_p "Do you want to go on a date tonight?"
                    call Kitty_Date_Night from _call_Kitty_Date_Night
    ...
    menu:
        ...
        "Do you want to be my girlfriend?" if "dating" not in K_Traits and "ex" not in K_Traits:
                ...
                if "asked boyfriend" in K_DailyActions and "angry" in K_DailyActions:
                    call KittyFace("angry", 1) from _call_KittyFace_1212
                    ch_k "For real, buzz off."
                    return
                elif "asked boyfriend" in K_DailyActions:
                    call KittyFace("angry", 1) from _call_KittyFace_1213
                    ch_k "Still \"nope.\""
                    return
                elif K_Break[0]:                    
                    call KittyFace("angry", 1) from _call_KittyFace_1214                    
                ...
                if K_Event[5]:
                    call KittyFace("bemused", 1) from _call_KittyFace_1215
                    ch_k "I {i}did{/i} ask you about that. . ."
                else:
                    call KittyFace("surprised", 2) from _call_KittyFace_1216
                    ch_k "I don't know, [K_Petname]. . ." 
                    call KittyFace("smile", 1) from _call_KittyFace_1217
                
                call Kitty_OtherWoman from _call_Kitty_OtherWoman
                
                if K_Love >= 800:
                    call KittyFace("surprised", 1) from _call_KittyFace_1218
                    $ K_Mouth = "smile"
                    ...
                    call KittyFace("kiss", 1) from _call_KittyFace_1219 
                    $ K_Kissed += 1
                elif K_Obed >= 500:
                    call KittyFace("perplexed") from _call_KittyFace_1220
                    ch_k "Maybe not so much \"dating\". . ."
                elif K_Inbt >= 500:
                    call KittyFace("smile") from _call_KittyFace_1221                
                    ch_k "That's not[K_like]where I'm at right now?"
                else:
                    call KittyFace("perplexed", 1) from _call_KittyFace_1222
        ...
        "When you said you loved me. . ." if "lover" not in K_Traits and K_Event[6] >= 20:
                call Kitty_Love_Redux from _call_Kitty_Love_Redux
        
        "Do you want to get back together?" if "ex" in K_Traits:
                $ K_DailyActions.append("relationship")
                if "asked boyfriend" in K_DailyActions and "angry" in K_DailyActions:
                    call KittyFace("angry", 1) from _call_KittyFace_1223
                    ch_k "Seriously, buzz off."
                    return
                elif "asked boyfriend" in K_DailyActions:
                    call KittyFace("angry", 1) from _call_KittyFace_1224
                    ch_k "Still no."
                    return
                elif K_Break[0]: 
                    call KittyFace("angry", 1) from _call_KittyFace_1225                    
                    if "dating" in R_Traits:   
                        ...
                        if not ApprovalCheck("Kitty", 1500) or K_Break[1] > 5:
                            ...
                            call KittyFace("sad", 1) from _call_KittyFace_1226
                            ch_k "Too soon."
                        $ K_DailyActions.append("asked boyfriend")
                        return
                ...
                $ Cnt = 0
                call Kitty_OtherWoman from _call_Kitty_OtherWoman_1
                                        
                if K_Love >= 800:
                    call KittyFace("surprised", 1) from _call_KittyFace_1227
                    $ K_Mouth = "smile"
                    ...
                    $ K_Traits.remove("ex")
                    "Kitty leaps in and kisses you deeply."
                    call KittyFace("kiss", 1) from _call_KittyFace_1228 
                    $ K_Kissed += 1
                elif K_Love >= 600 and ApprovalCheck("Kitty", 1500):
                    call KittyFace("smile", 1) from _call_KittyFace_1229
                    $ K_Mouth = "smile"
                    $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, 5)
                    ch_k "Um, ok, I guess."
                    if "boyfriend" not in K_Petnames:
                    ...
                    call KittyFace("kiss", 1) from _call_KittyFace_1230 
                    $ K_Kissed += 1
                elif K_Obed >= 500:
                    call KittyFace("sad") from _call_KittyFace_1231
                    ch_k "I think we're better like this."   
                elif K_Inbt >= 500:
                    call KittyFace("perplexed") from _call_KittyFace_1232                
                    ch_k "I kind of like what we have right now."
                else:
                    call KittyFace("perplexed", 1) from _call_KittyFace_1233
...
#                        ch_r "Yeah, you were."  
        ...
        "You said you wanted me to be more in control?" if "sir" not in K_Petnames and "sir" in K_History:
                if "asked sub" in K_RecentActions:
                        ...
                        call Kitty_Sub_Asked from _call_Kitty_Sub_Asked
        "You said you wanted me to be your Master?" if "master" not in K_Petnames and "master" in K_History:
                if "asked sub" in K_RecentActions:
                        ...
                        call Kitty_Sub_Asked from _call_Kitty_Sub_Asked_1
...
label Kitty_OtherWoman:
    $ Cnt = 0
    if "dating" in R_Traits:
        call KittyFace("perplexed") from _call_KittyFace_1234
        menu: 
            ...
            "She said I can be with you too." if "poly kitty" in R_Traits:
                ...
                if ApprovalCheck("Kitty", 1800, Bonus = Cnt):
                    call KittyFace("smile", 1) from _call_KittyFace_1235
                    if K_Love >= K_Obed:
                    ...
                    call KittyFace("angry", 1) from _call_KittyFace_1236
            ...
            "I could ask if she'd be ok with me dating you both." if "poly kitty" not in R_Traits:
                $Cnt = int((K_LikeRogue - 500)/2)
                if ApprovalCheck("Kitty", 1800, Bonus = Cnt):
                    call KittyFace("smile", 1) from _call_KittyFace_1237
                    if K_Love >= K_Obed:
                        ch_k "Just so long as we can be together, I can share."
                    elif K_Obed >= K_Inbt:
                        ch_k "I'm ok with that if she is."
                    ...
                    call KittyFace("angry", 1) from _call_KittyFace_1238
            ...
            "What she doesn't know won't hurt her.":
                ...
                if not ApprovalCheck("Kitty", 1800, Bonus = -(int((K_LikeRogue - 600)/2))): #checks if Rogue likes you more than Kitty
                    call KittyFace("angry", 1) from _call_KittyFace_1239
                    ...
                    call KittyFace("smile", 1) from _call_KittyFace_1240
                    if K_Love >= K_Obed:
        ...
        menu: 
            ...
            "She said I can be with you too." if "poly kitty" in E_Traits:
                ...
                if ApprovalCheck("Kitty", 1800, Bonus = Cnt):
                    ...
                    call KittyFace("angry", 1) from _call_KittyFace_1245
                    ch_k "Well maybe she did, but I don't want to share."  
                    $ renpy.pop_call() 
            ...
            "I could ask if she'd be ok with me dating you both." if "poly kitty" not in E_Traits:
                $Cnt = int((K_LikeEmma - 500)/2)
                if ApprovalCheck("Kitty", 1800, Bonus = Cnt):
                    call KittyFace("smile", 1) from _call_KittyFace_1246
                    if K_Love >= K_Obed:
                        ch_k "Just so long as we can be together, I can share."
                    elif K_Obed >= K_Inbt:
                        ch_k "I'm ok with that if she is."
                    ...
                    call KittyFace("angry", 1) from _call_KittyFace_1247
                    ch_k "Well maybe she would, but I don't want to share."      
                $ renpy.pop_call()
            ...
            "What she doesn't know won't hurt her.":
                ...
                if not ApprovalCheck("Kitty", 1800, Bonus = -(int((K_LikeEmma - 600)/2))): #checks if Emma likes you more than Kitty
                    call KittyFace("angry", 1) from _call_KittyFace_1248
                    if not ApprovalCheck("Kitty", 1800):
                        ch_k "Well I don't like you that much either."
                    else:
                    ...
                    call KittyFace("smile", 1) from _call_KittyFace_1249
                    if K_Love >= K_Obed:
                        ch_k "I really do want to be together with you."
                    elif K_Obed >= K_Inbt:
                        ch_k "If that's how you want it to be."
            ...
            "I can break it off with her.":
                call KittyFace("sad") from _call_KittyFace_1250
                ch_k "Well then maybe I'll see you tomorrow after you have."                                   
                $ renpy.pop_call()
                
            "You're right, I was dumb to ask.":
                call KittyFace("sad") from _call_KittyFace_1251
                ch_k "We had a good thing there. Maybe some day. . ."                    
                $ renpy.pop_call()                   
...
label Kitty_Settings:
    menu:
        ...
        "Her Pet Name":
                ...
                call Kitty_Pet from _call_Kitty_Pet   
        
        "\"Like\" options":    
                ch_p "So you[K_like]say \"[K_like]\" a lot. . ."      
                if ApprovalCheck("Kitty", 800):
                    call KittyLike from _call_KittyLike
                else:
        ...
        "Other girls":
                menu:
                    ...
                    "Rogue?":
                        call Kitty_AboutRogue from _call_Kitty_AboutRogue  
                    "Never mind.":
                        pass
        ...
        "Follow options" if "follow" in K_Traits:
                ...
                menu:
                    ...
                    "You can go where you want, I'll catch up later." if "freetravels" not in K_Traits:
                        call KittyFace("perplexed") from _call_KittyFace_1252
                        ch_k "Um[K_like]okay."
                    ...
                    "You can ask if I want to follow you." if "asktravels" not in K_Traits:
                        call KittyFace("perplexed") from _call_KittyFace_1253
                        ch_k "Um[K_like]okay."
                        if "follow" not in K_DailyActions:
                    ...
                    "Don't ever leave when I'm around." if "lockedtravels" not in K_Traits:
                        if ApprovalCheck("Kitty", 500, "O") or ApprovalCheck("Kitty", 900, "L"):   
                            call KittyFace("smile") from _call_KittyFace_1254
                            ...
                            call KittyFace("angry") from _call_KittyFace_1255                        
        ...
        "Tasks" if "sir" in K_Petnames:
                ...
                call Kitty_Controls from _call_Kitty_Controls
...
label Kitty_Chitchat(O=0, Options = ["default","default","default"]):
    if O:                                               #adds only a specific option that was sent
        ...
        if "hungry" not in K_Traits and (K_Swallow + K_Chat[2]) >= 10 and K_Loc == bg_current:  #She's swallowed a lot        
                call Kitty_Hungry from _call_Kitty_Hungry_1
                return  
...
#                $ Options.append("fuckbuddy?")  
    ...
    if Options[0] == "mandrill":                             
        ...
        call KittyFace("confused") from _call_KittyFace_1256
        ch_k "(sniff, sniff). . . is that. . . chimp? . . ."
        call KittyFace("perplexed", 1) from _call_KittyFace_1257
        ch_k ". . . but it's[K_like]. . . {i}sexy{/i} chimp?"    
    elif Options[0] == "purple":              
        $ K_DailyActions.append("cologne chat") 
        call KittyFace("sly",1) from _call_KittyFace_1258
        ch_k "(sniff, sniff). . . huh, what's that smell? . ."
        ch_k ". . . could I get you something?"    
    elif Options[0] == "corruption":              
        $ K_DailyActions.append("cologne chat") 
        call KittyFace("confused") from _call_KittyFace_1259
        ch_k "(sniff, sniff). . . that's pretty overpowering. . ."
        call KittyFace("sly") from _call_KittyFace_1260
        ch_k ". . . I may not be able to keep my hands to myself. . ."
            ...
            call KittyFace("smile",1) from _call_KittyFace_1261
            ...
            call KittyFace("sly",1) from _call_KittyFace_1264
                ...
                menu:
                    ...
                    "It was a total accident!  I promise!":             
                            ...
                            if ApprovalCheck("Kitty", 1200):
                                call KittyFace("sly",1) from _call_KittyFace_1265
                                ch_k "Yeah?  {i}Maybe{/i} you should[K_like]have accidents like that more often."
                            call KittyFace("smile") from _call_KittyFace_1266
                    ...
                    "Totally on purpose. I regret nothing.":
                            if ApprovalCheck("Kitty", 1200):                     
                                    ...
                                    call KittyFace("sly",1) from _call_KittyFace_1269
                                    ch_k "Hmm. . .next time, we'll have to[K_like]take advantage of the moment."
                            elif ApprovalCheck("Kitty", 800):                          
                                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 5)            
                                    $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 50, 5) 
                                    call KittyFace("perplexed",2) from _call_KittyFace_1270
                                    ch_k "Wha. . . um. . . okay?"
                                    $ K_Blush = 1
                            else:                
                                    ...
                                    call KittyFace("angry") from _call_KittyFace_1271
            ...
            menu:
                ...
                "Yeah?  Did you like them?":
                        call KittyFace("sly",2) from _call_KittyFace_1272
                ...
                "Good.  You looked like you could use to learn a thing or two from them.":                     
                        ...
                        $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 50, 5) 
                        call KittyFace("angry") from _call_KittyFace_1273
            ...
            call KittyFace("sly",2) from _call_KittyFace_1274
            ...
            call KittyFace("sly",2) from _call_KittyFace_1275
            ...
            if "blow" not in K_Chat:
                    ...
                    call KittyFace("sly",2) from _call_KittyFace_1276
                    ...
                    menu:
                        ...
                        "You were totally amazing.":                            
                                    ...
                                    call KittyFace("sexy",1) from _call_KittyFace_1277
                        ...
                        "I guess. If you're into weird sounds and too much teeth. Spoiler, I'm not.":                     
                                $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -10)          
                                $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 10)   
                                call KittyFace("angry",2) from _call_KittyFace_1280
            ...
            if "swallow" in K_Chat:                
                ...
                call KittyFace("sly",1) from _call_KittyFace_1281
                ch_k "Not bad. . ."
            ...
            call KittyFace("sexy",2) from _call_KittyFace_1282
            ...
            call KittyFace("sexy",2) from _call_KittyFace_1283
            ...
            call KittyFace("sly",2) from _call_KittyFace_1284
            ch_k "Y'know. . .after the other night, I'm kinda having trouble[K_like]sitting down."
            call KittyFace("sexy",2) from _call_KittyFace_1285
            ch_k "{i}Totally{/i} worth it, though."
            $ K_Blush = 1
        
    elif Options[0] == "boyfriend?":
        call Kitty_BF from _call_Kitty_BF_1
#    elif Options[0] == "lover?":
#        call Kitty_Love
    elif Options[0] == "sir?":
        call Kitty_Sub from _call_Kitty_Sub_1
    elif Options[0] == "master?":
        call Kitty_Master from _call_Kitty_Master_1
...
#        call Kitty_Daddy  
        ...
        ch_k "[Line]"
            ...
            if D20 == 1:
                    ...
                    call KittyFace("smile") from _call_KittyFace_1295
                    ...
                    call KittyFace("startled") from _call_KittyFace_1301
...
#            "Say you love her":
            ...
            "Touch her cheek.":                                                                                 #Touch her cheek 
                    call K_TouchCheek from _call_K_TouchCheek
            ...
            "Kiss her lips":                                                                                    #Kiss her
                    if ApprovalCheck("Kitty", 1000, TabM=1) or ApprovalCheck("Kitty", 600, "L", TabM=1):        
                        ...
                        call KittyFace("bemused", 1) from _call_KittyFace_1306
                        $ K_Eyes = "side"         
                        ...
                        call KittyFace("angry", 1) from _call_KittyFace_1307
                    ...
                    if K_Kissed:
                            ...
                            if ApprovalCheck("Kitty", 800, "L", TabM=1):
                                call KittyFace("surprised", 1) from _call_KittyFace_1313
                                ...
                                call KittyFace("sexy") from _call_KittyFace_1314
                                ch_k "Let me know if you want to do that again, [K_Petname]."
                            elif ApprovalCheck("Kitty", 650, "L", TabM=1):
                                call KittyFace("surprised", 1) from _call_KittyFace_1315
                                ...
                                call KittyFace("surprised", 1) from _call_KittyFace_1316            
                    ...
                    if ApprovalCheck("Kitty", 700, TabM=1):
                        ...
                        menu:
                            ...
                            "You know it.":
                                ...
                                call Kitty_SexAct("kissing") from _call_Kitty_SexAct_8
                                return
                            "Not now [[no].":
                                call KittyFace("bemused", 1) from _call_KittyFace_1319 
                            ...
                            "Nope.":
                                call KittyFace("angry", 1) from _call_KittyFace_1320
            ...
            "Hug her":                                                                                          #Hug her
                    if ApprovalCheck("Kitty", 300, TabM=1):        
                        ...
                        call KittyFace("angry", 1) from _call_KittyFace_1321
            ...
            "Slap her ass" if K_Loc == bg_current:                                                              #Slap her ass
                    call K_Slap_Ass from _call_K_Slap_Ass_14
                
            "Pinch her ass":                                                                                    #Pinch her ass
                    call KittyFace("surprised", 1) from _call_KittyFace_1327
                    if K_SEXP >= 5 and ApprovalCheck("Kitty", 700, TabM=1):        
                        "You come up to Kitty from behind and quickly pinch her butt."
                    else:                
                        "You come up to Kitty from behind and quickly pinch her butt."
                        call KittyFace("angry") from _call_KittyFace_1328
                    ...
                    if K_SEXP >= 40: 
                        ...
                        call KittyFace("sexy") from _call_KittyFace_1329
                        ch_k "Purrrr, Kitty like."
                    elif ApprovalCheck("Kitty", 800, "L", TabM=1):
                        call KittyFace("sexy") from _call_KittyFace_1330
                        $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, 1)           
                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 2)          
                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 90, 1)            
                        ...
                        call KittyFace("surprised") from _call_KittyFace_1331
                        $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, 1)           
                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 3)          
                        ...
                        call KittyFace("angry") from _call_KittyFace_1332
                        ...
                        call KittyFace("angry") from _call_KittyFace_1333
                        $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -8)           
                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 5)          
            ...
            "Open those zippers" if K_Panties == "zipper panties" or K_Chest == "bustier bra":
                    call KittyFace("sexy",2) from _call_KittyFace_1334
                    ch_k "Ok, [K_Petname]"
            ...
            "Pull her panties down" if not K_Legs and K_Panties and not K_PantiesDown and K_Panties != "swimsuit3" and K_Panties != "zipper panties" and K_Panties != "zipper panties open":
                    call KittyFace("surprised", 1) from _call_KittyFace_1335
                    #$ R_Upskirt = 1
                    $ K_PantiesDown = 1
                    pause 0.5            
                    #$ R_PantiesDown = 0
                    ...
                    if not Taboo: #no taboo
                        ...
                        call Kitty_First_Bottomless(1) from _call_Kitty_First_Bottomless_33 
                        
                    else: #no panties, taboo
                        if ApprovalCheck("Kitty", 850, "L") and ApprovalCheck("Kitty", 1500):
                            call KittyFace("sexy", 1) from _call_KittyFace_1341
                            ch_k "Oh, naughty, [K_Petname]!"
                            ch_k "You could have just asked, you know. . ."
                        elif ApprovalCheck("Kitty", 700, "L") and ApprovalCheck("Kitty", 1500):
                            call KittyFace("sexy", 1) from _call_KittyFace_1342
                            ch_k "[K_Petname]! A little warning!"
                        elif ApprovalCheck("Kitty", 700, "L"):
                            call KittyFace("bemused", 1) from _call_KittyFace_1343
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -3)           
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 3)  
                            ch_k "[K_Petname]! This isn't the time or place for this!"
                        elif ApprovalCheck("Kitty", 1000):
                            call KittyFace("angry", 1) from _call_KittyFace_1344
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -5)           
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 2)  
                            ch_k "Wha! [K_Petname]!"
                        else: 
                            call KittyFace("angry", 1) from _call_KittyFace_1345
                            ch_k "What the fuck, [K_Petname]!"
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -10)          
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 2)           
                            $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 80, 1) 
                        ...
                        $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 80, 4)  
                        call Kitty_First_Bottomless(1) from _call_Kitty_First_Bottomless_34                 
            ...
            "Pull her shorts down" if (K_Legs == "shorts" or K_Legs == "blue shorts" or K_Legs == "white shorts") and not K_PantiesDown and not K_Upskirt:
                    call KittyFace("surprised", 1) from _call_KittyFace_1346
                    $ K_Upskirt = 1
                    #$ K_PantiesDown = 1
                    pause 0.5            
                    #$ R_PantiesDown = 0
                    ...
                    if not Taboo: #no taboo
                        if ApprovalCheck("Kitty", 850, "L"):
                            call KittyFace("sexy", 1) from _call_KittyFace_1347
                            ch_k "Oh, naughty, [K_Petname]!"
                            ch_k "You could have just asked, you know. . ."
                        elif ApprovalCheck("Kitty", 700, "L"):
                            call KittyFace("sexy", 1) from _call_KittyFace_1348
                            ch_k "[K_Petname]! A little warning!"
                        elif ApprovalCheck("Kitty", 600, "L"):
                            call KittyFace("bemused", 1) from _call_KittyFace_1349
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -3)           
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 3)  
                            ch_k "Wha?! [K_Petname]? . . I don't usually. . ."
                        elif ApprovalCheck("Kitty", 500):
                            call KittyFace("angry", 1) from _call_KittyFace_1350
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -5)           
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 2)  
                            ch_k "Wha! [K_Petname]!"
                        else: 
                            call KittyFace("angry", 1) from _call_KittyFace_1351
                            ch_k "What the fuck, [K_Petname]!"
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -10)          
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 2)           
                            $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 80, 1) 
                        ...
                        if K_Panties:
                            ...
                            call Kitty_First_Bottomless(1) from _call_Kitty_First_Bottomless_35 
                        
                    else: #no panties, taboo
                        if ApprovalCheck("Kitty", 850, "L") and ApprovalCheck("Kitty", 1500):
                            call KittyFace("sexy", 1) from _call_KittyFace_1352
                            ch_k "Oh, naughty, [K_Petname]!"
                            ch_k "You could have just asked, you know. . ."
                        elif ApprovalCheck("Kitty", 700, "L") and ApprovalCheck("Kitty", 1500):
                            call KittyFace("sexy", 1) from _call_KittyFace_1353
                            ch_k "[K_Petname]! A little warning!"
                        elif ApprovalCheck("Kitty", 700, "L"):
                            call KittyFace("bemused", 1) from _call_KittyFace_1354
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -3)           
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 3)  
                            ch_k "[K_Petname]! This isn't the time or place for this!"
                        elif ApprovalCheck("Kitty", 1000):
                            call KittyFace("angry", 1) from _call_KittyFace_1355
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -5)           
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 2)  
                            ch_k "Wha! [K_Petname]!"
                        else: 
                            call KittyFace("angry", 1) from _call_KittyFace_1356
                            ch_k "What the fuck, [K_Petname]!"
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -10)          
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 2)           
                            $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 80, 1) 
                        ...
                        if K_Panties:
                            ...
                            call Kitty_First_Bottomless(1) from _call_Kitty_First_Bottomless_36                 
                    $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 1) 
                    if "exhibitionist" in K_Traits:
                        $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 200, 4) 
                    #End Flip her Skirt 
            ...
            "Grab her tit":                                                                                     #Grab her tit
                    call KittyFace("surprised", 1) from _call_KittyFace_1357
                    if K_SEXP >= 5 and ApprovalCheck("Kitty", 700, TabM=2):        
                        "You come up to Kitty and quickly honk her boob."
                    else:             
                        "You come up to Kitty and quickly honk her boob."
                        call KittyFace("angry") from _call_KittyFace_1358
                        show Kitty_Sprite
                        with vpunch
                    ...
                    if K_SEXP >= 40: 
                        ...
                        call KittyFace("angry") from _call_KittyFace_1363
                        $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -8)          
                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 90, 5)            
                        $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 90, 2) 
                            ...
                            menu:
                                ...
                                "Honk it again and let go":
                                    if Count >= 7:
                                        ...
                                        call KittyFace("angry") from _call_KittyFace_1368
                                        ch_k "Douche."
                                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 70, 3)            
                                    $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 70, 2)
                                    $ Count = 0 
                                ...
                                "Fondle it a little":                            
                                    if K_FondleB and ApprovalCheck("Kitty", 1100, TabM=2):                                
                                        call KittyFace("sexy",1) from _call_KittyFace_1369
                                        $ K_Eyes = "closed"
                                        $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 90, 5) 
                                    else:
                                        call KittyFace("perplexed") from _call_KittyFace_1370
                                        $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 90, 2) 
                                        $ Count -= 1
                                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 70, 4)            
                                    $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 70, 2)
                                ...
                                "Just leave it there.":
                                    if Count == 5:
                                        call KittyFace("perplexed") from _call_KittyFace_1371
                                        $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 90, 3) 
                                        ch_k "Huh."                            
                                    elif Count == 2:
                                        call KittyFace("perplexed") from _call_KittyFace_1372
                                        $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 90, 1) 
                    ...
                    if K_FondleB and ApprovalCheck("Kitty", 1200, TabM = 3): 
                        call KittyFace("sexy", 1) from _call_KittyFace_1373
                        ...
                        menu:
                            ...
                            "Yeah!":
                                ...
                                call Kitty_SexAct("breasts") from _call_Kitty_SexAct_9
                                return
                            "Nah, that was enough.":
                                call KittyFace("sad", 1) from _call_KittyFace_1374
                                $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 2) 
                                $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -2)          
                                $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 4)            
                                $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 2) 
                        ...
                        call KittyFace("angry", 1) from _call_KittyFace_1375
                        ch_k "How could you do that in public?"
                    else:
                        call KittyFace("angry", 1) from _call_KittyFace_1376
            ...
            "Rub her shoulders":                                                                                #Rub her shoulders
                    ...
                    if K_SEXP >= 30:
                        call KittyFace("sexy") from _call_KittyFace_1377 
                        $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 3) 
                        $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, 2)
                        "She sinks back into your hands"
                        ch_k "Hmm, getting frisky, [K_Petname]?"
                    elif ApprovalCheck("Kitty", 650, "L"):
                        call KittyFace("sexy") from _call_KittyFace_1378
                        $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 1) 
                        $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, 2)
                        ch_k "Purr, that's nice, [K_Petname]."
                    elif ApprovalCheck("Kitty", 500):
                        call KittyFace("surprised", 1) from _call_KittyFace_1379
                        $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, 1)
                        ch_k "Oh, hey, [K_Petname]. What's up?"
                    elif ApprovalCheck("Kitty", 400):
                        call KittyFace("angry", 1) from _call_KittyFace_1380
                        $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -1)
                        if Taboo:
                        ...
                        call KittyFace("angry", 1) from _call_KittyFace_1381
            ...
            "Ask for her panties" if K_Panties != "swimsuit3":
                    call Kitty_AskPanties from _call_Kitty_AskPanties
...
label Kitty_AskPanties(Store = 0):
    ...
    if not K_Panties or K_Panties == "shorts" or K_Panties == "blue shorts" or K_Panties == "white shorts":
        if ApprovalCheck("Kitty", 900):
            call KittyFace("sexy", 1) from _call_KittyFace_1382
            ...
            call KittyFace("bemused", 2) from _call_KittyFace_1383
            $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 5)          
            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, -3)            
            $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 3)
            ch_k "Um[K_like]what?"
            ...
            call KittyFace("angry", 1) from _call_KittyFace_1384
            $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 5) 
            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -5)          
            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, -5)            
            $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 40, 2) 
        ...
        if Line == "here":                              
                ...
                call KittyFace("sly") from _call_KittyFace_1385                          
                if K_Legs == "skirt":      
                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 4)            
                ...
                $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 5)    
                call Remove_Panties("Kitty") from _call_Remove_Panties_6
                ...
                if Taboo:
                    ...
                    call KittyFace("bemused", 1) from _call_KittyFace_1386 
                    menu:
                        ch_k "Could you turn around?"
                        "OK.": 
                            $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, 5) 
                            call KittyFace("smile", 1) from _call_KittyFace_1387                                             
                            ch_k "Thanks, [K_Petname]."
                            call KittyFace("sly", 1) from _call_KittyFace_1388 
                            $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 2)         
                            $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 4)            
                            $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 4)
                            ...
                            call KittyOutfit from _call_KittyOutfit_48                             
                            hide blackscreen onlayer black 
                            if Taboo:              
                                call Quick_Taboo("Kitty") from _call_Quick_Taboo_9
                        ...
                        "And miss the show?":
                            if ApprovalCheck("Kitty", 1000, "LI"): 
                                ...
                                $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 5)            
                                $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 5) 
                                call KittyFace("sly", 1) from _call_KittyFace_1389 
                                ch_k "Oh, you think there's a show?"
                            else:                 
                                call KittyFace("angry", 1) from _call_KittyFace_1390 
                                $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -5)          
                                $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, -3)            
                                $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 5) 
                                ch_k "Apparently so."
                        ...
                        "Nope, I'm staying.":
                            if ApprovalCheck("Kitty", 600, "OI"): 
                                call KittyFace("bemused", 1) from _call_KittyFace_1391 
                                $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 70, 5)          
                                $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 10)            
                                $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 5) 
                                ch_k "Ok."
                                call KittyFace("sexy") from _call_KittyFace_1392 
                            else:        
                                call KittyFace("angry", 1) from _call_KittyFace_1393 
                                $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, -10)          
                                $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, -5)            
                                $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 5) 
                    ...
                    if Line:                                            #She agreed to stay  
                                call KittyFace("sly", 1) from _call_KittyFace_1394 
                                if K_Legs or HoseNum("Kitty") >= 10:   
                                        $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 5)         
                                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 3)            
                                        $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 5)  
                                        
                                call Remove_Panties("Kitty") from _call_Remove_Panties_7 
                                
        else:                                           #She refuses.    
            call KittyFace("angry", 2) from _call_KittyFace_1395                        
            if not ApprovalCheck("Kitty", 500):
                ...
                call KittyFace("bemused", 2) from _call_KittyFace_1396
                $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 60, 3)            
                ...
                if K_Love >= K_Inbt or K_Obed >= K_Inbt:
                    ...
                    call KittyFace("perplexed") from _call_KittyFace_1397       
                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, -2)    
...
label Kitty_Controls:
    menu:
        "I'd like you to call me something else":
            call Kitty_Names from _call_Kitty_Names_1            
            return
        "I'd like you to come over for some action." if K_Loc != bg_current:
            ch_k "Ok, I'll be right over."
            $ K_Loc = bg_current 
            call Set_The_Scene from _call_Set_The_Scene_192
            call Kitty_SexMenu from _call_Kitty_SexMenu_7
            return
        "I'd like to get busy." if K_Loc == bg_current:
            ch_k "Oh do you?"
            call Kitty_SexMenu from _call_Kitty_SexMenu_8
            return
    ...
    menu:
        ...
        "Give her a dildo." if "dildo" in P_Inventory: #If you have a Dildo, you'll give it.
            ...
            if "dildo" not in K_Inventory:                            
                ...
                if ApprovalCheck("Kitty", 1200) or ApprovalCheck("Kitty", 600, "I"):                    
                    call KittyFace("bemused") from _call_KittyFace_1398
                    ...
                    call KittyFace("confused") from _call_KittyFace_1399
                    $ P_Inventory.remove("dildo")
                    $ K_Inventory.append("dildo")
                    ...
                    $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 89, 10)
                    call KittyFace("surprised") from _call_KittyFace_1400
                    ch_k "Oh!"
                    ch_k "Oh. . . I'll just[K_like]put it away."
                    call KittyFace("bemused") from _call_KittyFace_1401
                elif "offered gift" in K_DailyActions:
                    call KittyFace("angry") from _call_KittyFace_1402
                    "She hands it back to you."
                    ch_k "I think I[K_like]made myself clear about inappropriate gifts?"     
                else:
                    call KittyFace("angry") from _call_KittyFace_1403
        ...
        "Give her the vibrator." if "vibrator" in P_Inventory: #If you have a vibrator, you'll give it.
            ...
            if "vibrator" not in K_Inventory:                            
                ...
                if ApprovalCheck("Kitty", 700):                    
                    call KittyFace("bemused") from _call_KittyFace_1404
                    ...
                    call KittyFace("confused") from _call_KittyFace_1405
                    $ P_Inventory.remove("vibrator")
                    $ K_Inventory.append("vibrator")
                    $ K_Love = Statupdate("Kitty", "Love", K_Love, 200, 10)
                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 200, 10)
                    ...
                    $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 89, 10)
                    call KittyFace("surprised") from _call_KittyFace_1406
                    ch_k "-for my back!"
                    call KittyFace("bemused", 1) from _call_KittyFace_1407
                elif "offered gift" in K_DailyActions:
                    call KittyFace("angry") from _call_KittyFace_1408
                    "She hands it back to you."
                    ch_k "I think I[K_like]made myself clear about inappropriate gifts?"   
                else:
                    call KittyFace("angry") from _call_KittyFace_1409
                    $ K_Love = Statupdate("Kitty", "Love", K_Love, 50, -20)
                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 20, 10)
                    $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 20, 20)                    
        ...
        "Give her the lace bra." if "lace bra" in P_Inventory: #If you have a bra, you'll give it.
            ...
            if "lace bra" not in K_Inventory:                            
                ...
                if ApprovalCheck("Kitty", 1200):                    
                    call KittyFace("bemused") from _call_KittyFace_1410
                    ...
                    call KittyFace("confused",1) from _call_KittyFace_1411
                    $ P_Inventory.remove("lace bra")
                    $ K_Inventory.append("lace bra")
                    ...
                    call KittyFace("bemused",1) from _call_KittyFace_1412
                elif ApprovalCheck("Kitty", 600):
                    call KittyFace("confused",2) from _call_KittyFace_1413
                    $ P_Inventory.remove("lace bra")
                    $ K_Inventory.append("lace bra")
                    $ K_Love = Statupdate("Kitty", "Love", K_Love, 200, 20)
                    ...
                    call KittyFace("bemused",1) from _call_KittyFace_1414
                elif "no gift bra" in K_RecentActions:
                    call KittyFace("angry",2) from _call_KittyFace_1415
                    ch_k "I just told you no, stop being a creepazoid!"
                elif "no gift bra" in K_DailyActions:
                    call KittyFace("angry",2) from _call_KittyFace_1416
                    ch_k "I haven't changed my mind, stop bothering me!"      
                else:
                    call KittyFace("angry",2) from _call_KittyFace_1417
                    $ K_Love = Statupdate("Kitty", "Love", K_Love, 50, -10)
                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 20, 10)
                    $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 20, 20)  
        ...
        "Give her the lace panties." if "lace panties" in P_Inventory: #If you have a bra, you'll give it.
            ...
            if "lace panties" not in K_Inventory:                            
                ...
                $ K_Blush = 1
                if ApprovalCheck("Kitty", 1200):                    
                    call KittyFace("bemused") from _call_KittyFace_1418
                    ...
                    call KittyFace("confused",1) from _call_KittyFace_1419
                    $ P_Inventory.remove("lace panties")
                    $ K_Inventory.append("lace panties")
                    $ K_Love = Statupdate("Kitty", "Love", K_Love, 200, 20)
                    ...
                    call KittyFace("bemused",1) from _call_KittyFace_1420
                elif ApprovalCheck("Kitty", 700):
                    call KittyFace("confused",2) from _call_KittyFace_1421
                    $ P_Inventory.remove("lace panties")
                    $ K_Inventory.append("lace panties")
                    $ K_Love = Statupdate("Kitty", "Love", K_Love, 200, 20)
                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 200, 20)
        ...
        "Give her the \"Dazzler and Longshot\" book." if "Dazzler and Longshot" in P_Inventory: #If you have a vibrator, you'll give it.
            ...
            if "Dazzler and Longshot" not in K_Inventory:                            
                ...
                if ApprovalCheck("Kitty", 600, "L"):                    
                    call KittyFace("smile") from _call_KittyFace_1426
                    ch_k "Oh, this one's so sweet!"
                    $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 89, 10)
                else:
                    call KittyFace("confused") from _call_KittyFace_1427
                    ch_k "Hm, worth the read I guess."  
                    call KittyFace("bemused") from _call_KittyFace_1428       
        ...
        "Give her the \"256 Shades of Grey\" book." if "256 Shades of Grey" in P_Inventory: #If you have a book, you'll give it.
            ...
            if "256 Shades of Grey" not in K_Inventory:                            
                ...
                if ApprovalCheck("Kitty", 500, "O"):                    
                    call KittyFace("bemused") from _call_KittyFace_1429
                    ch_k "I'll give it a good look."
                    $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 89, 10)
                else:
                    call KittyFace("confused") from _call_KittyFace_1430 
                    ch_k "Hmm, I guess I could read a few chapters."  
                    call KittyFace("bemused") from _call_KittyFace_1431             
        ...
        "Give her the \"Avengers Tower Penthouse\" book." if "Avengers Tower Penthouse" in P_Inventory: #If you have a book, you'll give it.
            ...
            if "Avengers Tower Penthouse" not in K_Inventory:                            
                ...
                if ApprovalCheck("Kitty", 500, "I"):                    
                    call KittyFace("bemused") from _call_KittyFace_1432
                    ch_k "This should be fun. . ."
                    $ K_Lust = Statupdate("Kitty", "Lust", K_Lust, 89, 10)
                else:
                    call KittyFace("confused") from _call_KittyFace_1433
                    ch_k "Well. . . this is a bit. . . I could maybe learn a few things."  
                    call KittyFace("bemused") from _call_KittyFace_1434               
                ...
                menu:
                    ...
                    "I think I'll call you \"girl\".":
                        ...
                        if "boyfriend" in K_Petnames or ApprovalCheck("Kitty", 500, "L"):
                            call KittyFace("sexy", 1) from _call_KittyFace_1435 
                            ch_k "I'm totally your girl, [K_Petname]."
                        else:      
                            call KittyFace("angry") from _call_KittyFace_1436           
                            ch_k "I'm NOT your girl, [K_Petname]." 
                            
                    "I think I'll call you \"boo\".":
                        $ K_Pet = "boo"
                        if "boyfriend" in K_Petnames or ApprovalCheck("Kitty", 500, "L"):
                            call KittyFace("sexy", 1) from _call_KittyFace_1437 
                            ch_k "Aw, I am your boo, [K_Petname]."
                        else:     
                            call KittyFace("angry") from _call_KittyFace_1438            
                            ch_k "I'm NOT your boo,  [K_Petname]."
                            
                    "I think I'll call you \"bae\".":
                        $ K_Pet = "bae"
                        if "boyfriend" in K_Petnames or ApprovalCheck("Kitty", 500, "L"):
                            call KittyFace("sexy", 1) from _call_KittyFace_1439 
                            ch_k "Aw, I am your bae, [K_Petname]."
                        else:     
                            call KittyFace("angry") from _call_KittyFace_1440            
                            ch_k "I'm NOT your bae,  [K_Petname]."
                            
                    "I think I'll call you \"baby\".":
                        $ K_Pet = "baby"
                        if "boyfriend" in K_Petnames or ApprovalCheck("Kitty", 500, "L"):
                            call KittyFace("sexy", 1) from _call_KittyFace_1441 
                            ch_k "Aw, cute, [K_Petname]."
                        else:     
                            call KittyFace("angry") from _call_KittyFace_1442            
                            ch_k "I'm not a baby!" 
                    ...
                    "I think I'll call you \"sweetie\".":
                        ...
                        if "boyfriend" in K_Petnames or ApprovalCheck("Kitty", 500, "L"):
                            ...
                            call KittyFace("angry", 1) from _call_KittyFace_1443            
                            ch_k "Too saccharine, [K_Petname]."
                            
                    "I think I'll call you \"sexy\".":
                        $ K_Pet = "sexy"
                        if "lover" in K_Petnames or ApprovalCheck("Kitty", 900):
                            call KittyFace("sexy", 1) from _call_KittyFace_1444 
                            ch_k "Mreow, [K_Petname]."
                        else:        
                            call KittyFace("angry", 1) from _call_KittyFace_1445         
                            ch_k "Not in public, [K_Petname]."  
                            
                    "I think I'll call you \"lover\".":
                        $ K_Pet = "lover"
                        if "lover" in K_Petnames or ApprovalCheck("Kitty", 900):
                            call KittyFace("sexy", 1) from _call_KittyFace_1446 
                            ch_k "Love you too, [K_Petname]!"
                        else:      
                            call KittyFace("angry", 1) from _call_KittyFace_1447           
                            ch_k "Not in this lifetime, [K_Petname]."  
                    
                    "I think I'll call you \"kitten\".":
                        $ K_Pet = "baby"
                        if "boyfriend" in K_Petnames or ApprovalCheck("Kitty", 500, "L"):
                            call KittyFace("sexy", 1) from _call_KittyFace_1448 
                            ch_k "Purrr, [K_Petname]."
                        else:     
                            call KittyFace("angry") from _call_KittyFace_1449            
                ...
                menu:                        
                    "I think I'll call you \"slave\".":
                        ...
                        if "master" in K_Petnames or ApprovalCheck("Kitty", 700, "O"):
                            call KittyFace("bemused", 1) from _call_KittyFace_1450 
                            ch_k "As you wish, [K_Petname]."
                        else:      
                            call KittyFace("angry", 1) from _call_KittyFace_1451           
                            ch_k "I'm not slave, [K_Petname]."
                                            
                    "I think I'll call you \"pet\".":
                        $ K_Pet = "pet"
                        if "master" in K_Petnames or ApprovalCheck("Kitty", 600, "O"):
                            call KittyFace("bemused", 1) from _call_KittyFace_1452 
                            ch_k "Hmm, make sure to pet me, [K_Petname]."
                        else:             
                            call KittyFace("angry", 1) from _call_KittyFace_1453    
                            ch_k "I'm no house cat, [K_Petname]."
                            
                    "I think I'll call you \"slut\".":
                        $ K_Pet = "slut"
                        if "sex friend" in K_Petnames or ApprovalCheck("Kitty", 1000, "OI"):
                            call KittyFace("sexy") from _call_KittyFace_1454 
                            ch_k "If the name fits, [K_Petname]."
                        else:                
                            call KittyFace("angry", 1) from _call_KittyFace_1455 
                            $ K_Mouth = "surprised"
                    ...
                    "I think I'll call you \"whore\".":
                        ...
                        if "fuckbuddy" in K_Petnames or ApprovalCheck("Kitty", 1100, "OI"):
                            call KittyFace("sly") from _call_KittyFace_1456 
                            ch_k "Only for you though. . ."
                        else:        
                            call KittyFace("angry", 1) from _call_KittyFace_1457         
                    ...
                    "I think I'll call you \"sugartits\".":
                        ...
                        if "sex friend" in K_Petnames or ApprovalCheck("Kitty", 1400):
                            call KittyFace("sly", 1) from _call_KittyFace_1458 
                            ch_k "These little things?"
                        else:     
                            call KittyFace("angry", 1) from _call_KittyFace_1459            
                            ch_k "I would hope not, [K_Petname]." 
                            
                    "I think I'll call you \"sex friend\".":
                        $ K_Pet = "sex friend"
                        if "sex friend" in K_Petnames or ApprovalCheck("Kitty", 600, "I"):
                            call KittyFace("sly") from _call_KittyFace_1460 
                            ch_k "Rreow. . ."
                        else:                
                            call KittyFace("angry", 1) from _call_KittyFace_1461 
                            ch_k "Not out loud, [K_Petname]." 
                            
                    "I think I'll call you \"fuckbuddy\".":
                        $ K_Pet = "fuckbuddy"
                        if "fuckbuddy" in K_Petnames or ApprovalCheck("Kitty", 700, "I"):
                            call KittyFace("sly") from _call_KittyFace_1462 
                            ch_k "Yup."
                        else:                
                            call KittyFace("angry", 1) from _call_KittyFace_1463
                            $ K_Mouth = "surprised"
                    ...
                    "I think I'll call you \"baby girl\".":
                        ...
                        if "daddy" in K_Petnames or ApprovalCheck("Kitty", 1200):
                            call KittyFace("smile", 1) from _call_KittyFace_1464 
                            ch_k "You know it, [K_Petname]."
                        else:                
                            call KittyFace("angry", 1) from _call_KittyFace_1465 
                            ch_k "I'm no kid!" 
...
label Kitty_Summon(Tempmod=Tempmod):
    call KittyOutfit from _call_KittyOutfit_49  
    ...
    if Current_Time == "Night": 
                if ApprovalCheck("Kitty", 700, "L") or ApprovalCheck("Kitty", 300, "O"):                              #It's night time but she likes you.
                        ...
                        $ K_Loc = bg_current 
                        call Set_The_Scene from _call_Set_The_Scene_193
    ...
    $ K_Loc = bg_current 
    call KittyOutfit from _call_KittyOutfit_50
    call Set_The_Scene from _call_Set_The_Scene_194
    return
...
label Kitty_Leave(Tempmod=Tempmod, GirlsNum = 0):        
    if "leaving" in K_RecentActions:
        call DrainWord("Kitty","leaving") from _call_DrainWord_220
    else:
        return
    ...
    if "Kitty" in Party or "lockedtravels" in K_Traits:           
            ...
            call KittyOutfit from _call_KittyOutfit_51           
    ...
    call KittyOutfit from _call_KittyOutfit_52  
    ...
    if not Line:                                                                        
            #You end the dialog neutrally      
            hide Kitty_Sprite
            call Gym_Clothes("auto", "Kitty") from _call_Gym_Clothes_26
            call Pool_Clothes("auto", "Kitty") from _call_Pool_Clothes_20
            return
    ...
    if Line == "no":                                                                    
            ...
            hide Kitty_Sprite
            call Gym_Clothes("auto", "Kitty") from _call_Gym_Clothes_27  
            call Pool_Clothes("auto", "Kitty") from _call_Pool_Clothes_21       
            return
        
    elif Line == "go to":                                                                 
            #You agreed to go to her instead  
            $ Tempmod = 0
            call DrainWord("All","leaving") from _call_DrainWord_221  
            call DrainWord("All","arriving") from _call_DrainWord_222        
            hide Kitty_Sprite
            call Gym_Clothes("auto", "Kitty") from _call_Gym_Clothes_28
            call Pool_Clothes("auto", "Kitty") from _call_Pool_Clothes_22
            if K_Loc == "bg classroom":
...
label Kitty_Dismissed(Leaving = 0):
    if "Kitty" in Party:        
            $ Party.remove("Kitty")
    call Kitty_Schedule(0) from _call_Kitty_Schedule_4 #if K_Loc == bg_current then it means she wants to stay here
    menu:
        ...
        "You can go now.":                         
                if K_Loc != bg_current and not ApprovalCheck("Kitty", 450, "O"):
                        ...
                        call KittyFace("confused") from _call_KittyFace_1466 
                ...
                "I insist, get going.":  
                        if K_Loc != bg_current and (ApprovalCheck("Kitty", 1200, "LO") or ApprovalCheck("Kitty", 400, "O")):
                                ...
                                if "dismissed" not in K_DailyActions:
                                        ...
                                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 60, 10)
                                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 5)
                                call KittyFace("angry") from _call_KittyFace_1467 
                                ch_k "Fine, jerk!"      
                                $ Leaving = 1                         
                        elif K_Loc != bg_current:
                                ...
                                call KittyFace("angry") from _call_KittyFace_1468 
                                ch_k "Noooope."          
                                ...
                                if "dismissed" not in K_DailyActions:
                                        ...
                                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 50, 10)
                                        $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 80, 5)
                                call KittyFace("sad") from _call_KittyFace_1469 
                                ch_k "Um, sure, fine."
                                $ Leaving = 1                   
                        else:
                                ...
                                if "dismissed" not in K_DailyActions:
                                        ...
                                        $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 50, 3)
                                        $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 80, 2)
                                call KittyFace("sad") from _call_KittyFace_1470 
                                ch_k "Yeah right."          
                "Ok, nevermind.":    
                                pass
...
## Kitty's Clothes ///////////////////
label Kitty_Clothes:    
    call KittyFace from _call_KittyFace_1471
    menu:
        ...
        "That looks really good on you, you should remember that one. [[Set Custom]":
                menu:
                    ...
                    "Custom 1":
                                call Kitty_OutfitShame(3,1) from _call_Kitty_OutfitShame_1
                    "Custom 2":
                                call Kitty_OutfitShame(5,1) from _call_Kitty_OutfitShame_2
                    "Custom 3":
                                call Kitty_OutfitShame(6,1) from _call_Kitty_OutfitShame_3
                    "Custom 4":
                                call Kitty_OutfitShame(11,1) from _call_Kitty_OutfitShame_4
                    "Custom 5":
                                call Kitty_OutfitShame(12,1) from _call_Kitty_OutfitShame_5
                    "Custom 6":
                                call Kitty_OutfitShame(13,1) from _call_Kitty_OutfitShame_6
                    "Custom 7":
                                call Kitty_OutfitShame(14,1) from _call_Kitty_OutfitShame_7
                    "Gym Clothes":
                                call Kitty_OutfitShame(7,1) from _call_Kitty_OutfitShame_8
                    "Sleepwear":
                                call Kitty_OutfitShame(9,1) from _call_Kitty_OutfitShame_9
                    "Never mind":
                                pass
...
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 
    ...
    menu Kitty_Clothes_Outfits:                                                                                 # Outfits
        "I really like that pink shirt and capris outfit you wear.":                   #Green
            call KittyOutfit("pink outfit") from _call_KittyOutfit_53   
            menu:
        ...
        "Put on that black dress":                   #Green
            call KittyOutfit("black dress") from _call_KittyOutfit_54   
            menu:
                "You should wear this one out. [[set current outfit]":
        ...
        "Put on that kitty lingerie":                   #Green
            call KittyOutfit("kitty lingerie") from _call_KittyOutfit_55   
            menu:
                "You should wear this one out. [[set current outfit]":
        ...
        "Put on that bondage outfit" if K_Bondage:
            call KittyOutfit("zipper bondage") from _call_KittyOutfit_56   
            menu:
                "You should wear this one out. [[set current outfit]":
        ...
        "That red shirt and black jeans look really nice on you.":                           #Pink  
            call KittyOutfit("red outfit") from _call_KittyOutfit_57
            menu:
                "You should wear this one out. [[set current outfit]":
                    $ K_Outfit = "red outfit"
            ...
            while 1:
                menu:                
                    ...
                    "You should wear this one out." if Cnt:
                        call Kitty_Custom_Out(Cnt) from _call_Kitty_Custom_Out
                    "Ok, back to what we were talking about. . .":
                        $ Cnt = 0
                        jump Kitty_Clothes_Outfits                    
        
        "Your birthday suit looks really great. . .":                                     #Nude
            call KittyFace("sexy", 1) from _call_KittyFace_1472
            $ Line = 0
            if not K_Chest and not K_Panties and not K_Over and not K_Legs and not K_Hose:                
                ...
                call KittyFace("surprised", 2) from _call_KittyFace_1473
                ch_k "[K_Like]get to know a girl first, [K_Petname]."
                $ K_Blush = 1
            else:
                call KittyFace("angry", 1) from _call_KittyFace_1474
                ch_k "Yeah[K_like]it does."    
                
            if Line:                                                            #If she got nude. . .                            
                call KittyOutfit("nude") from _call_KittyOutfit_65
                "She lets all her clothes drop into a pile at her feet."
                call Kitty_First_Topless from _call_Kitty_First_Topless_19
                call Kitty_First_Bottomless(1) from _call_Kitty_First_Bottomless_37
                call KittyFace("sexy") from _call_KittyFace_1475
                menu:
                    "You know, you should wear this one out. [[set current outfit]":
                        if "exhibitionist" in K_Traits:
                            ...
                            call KittyFace("sexy", 1) from _call_KittyFace_1476
                            $ K_Eyes = "surprised"
...
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 
    ...
    menu Kitty_Clothes_Over:                                                                                            # Overshirts
        ...
        "Try on that pink shirt you have." if K_Over != "pink top":
            call KittyFace("bemused") from _call_KittyFace_1480
            if K_Chest or K_SeenChest:
                ch_k "K."
            elif ApprovalCheck("Kitty", 800, TabM=0):
                ch_k "Yeah, ok."          
            else:
                call KittyFace("bemused", 1) from _call_KittyFace_1481
                ch_k "This top is a little skimpy for what I have on under it."
                jump Kitty_Clothes    
            $ K_Over = "pink top"  

        "Try on that dark shirt you have." if K_Over != "dark top":
            call KittyFace("bemused") from _call_KittyFace_1482
            if K_Chest or K_SeenChest:
                ch_k "K."
            elif ApprovalCheck("Kitty", 800, TabM=0):
                ch_k "Yeah, ok."          
            else:
                call KittyFace("bemused", 1) from _call_KittyFace_1483
                ch_k "This top is a little skimpy for what I have on under it."
                jump Kitty_Clothes    
            $ K_Over = "dark top"   
        ...
        "Maybe just throw on a towel?" if K_Over != "towel":
            call KittyFace("bemused", 1) from _call_KittyFace_1484
            if K_Chest or K_SeenChest:
                ch_k "Weirdo."
            elif ApprovalCheck("Kitty", 1000, TabM=0):
                call KittyFace("perplexed", 1) from _call_KittyFace_1485
                ch_k "I guess? . ."          
            else:
        ...
        menu:
            ...
            "You could always just wear nothing at all. . .":
                        if ApprovalCheck("Kitty", 1100, "LI", TabM=2) and K_Love > K_Inbt:               
                                ...
                                call KittyFace("surprised") from _call_KittyFace_1486
                                $ K_Brows = "angry"
                                if Taboo:
                                    ch_k "Not in public,[K_Petname]!"
                                else:
...
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 
    ...
    menu Kitty_Clothes_Legs:                                                                                                    # Leggings    
        "Maybe go without the pants." if PantsNum("Kitty") > 5:
            call KittyFace("sexy", 1) from _call_KittyFace_1487
            if K_SeenPanties and K_Panties and ApprovalCheck("Kitty", 500, TabM=5):
                ...
                call Kitty_NoPantiesOn from _call_Kitty_NoPantiesOn
                if not _return:
                    jump Kitty_Clothes
            else:
            ...
            if K_Panties:                
                ...
                call Kitty_First_Bottomless from _call_Kitty_First_Bottomless_38
        
        "Why don't you lose the shorts?" if K_Legs == "shorts" or K_Legs == "blue shorts" or K_Legs == "white shorts":
            call KittyFace("sexy", 1) from _call_KittyFace_1488
            if K_SeenPussy and ApprovalCheck("Kitty", 900, TabM=4): 
                ...
                call Kitty_NoPantiesOn from _call_Kitty_NoPantiesOn_1
                if not _return:
                    jump Kitty_Clothes
            ...
            if K_Panties:                
                ...
                call Kitty_First_Bottomless from _call_Kitty_First_Bottomless_39
                $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 50, 2)  
        ...
        menu:
            ...
            "You could always just wear nothing at all. . .":
                        if ApprovalCheck("Kitty", 1100, "LI", TabM=3) and K_Love > K_Inbt:               
                                ...
                                call KittyFace("surprised") from _call_KittyFace_1489
                                $ K_Brows = "angry"
                                if Taboo:
                                    ch_k "Not in public, [K_Petname]!"
                                else:
        ...
        "Tops and bras":
            menu Kitty_Clothes_Under_Tops:  
                ...
                "How about you lose the [K_Chest]?" if K_Chest and "swimsuit" not in K_Chest:
                    call KittyFace("bemused", 1) from _call_KittyFace_1490
                ...
                "Try on that yellow camisole." if K_Chest != "cami":
                    call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top
                    ch_k "Ok."
                    $ K_Chest = "cami"
                    jump Kitty_Clothes_Under_Tops

                "Try on that white camisole." if K_Chest != "white cami":
                    call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_1
                    ch_k "Ok."
                    $ K_Chest = "white cami"
                    jump Kitty_Clothes_Under_Tops
                             
                "Try on that orange top." if K_Chest != "orange top":
                    call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_2
                    ch_k "Ok."
                    $ K_Chest = "orange top" 
                    jump Kitty_Clothes_Under_Tops  

                "Try on that black mfg top." if K_Chest != "black top":
                    call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_3
                    ch_k "Ok."
                    $ K_Chest = "black top" 
                    jump Kitty_Clothes_Under_Tops          
        
                "How about that leather top?" if K_Chest != "leather top":
                    call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_4
                    ch_k "Mkay."
                    $ K_Chest = "leather top"
                    jump Kitty_Clothes_Under_Tops
                ...
                "I like that strapless bra." if K_Chest != "bra":
                    if K_SeenChest or ApprovalCheck("Kitty", 1200, TabM=2):
                        call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_5
                        ch_k "K."   
                        $ K_Chest = "bra"         
                    else:                
                ...
                "I like that lace bra." if "lace bra" in K_Inventory and K_Chest != "lace bra":
                    if K_SeenChest or ApprovalCheck("Kitty", 1300, TabM=2):
                        call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_6
                        ch_k "K."   
                        $ K_Chest = "lace bra"         
                    else:                
                ...
                "I like that darker lace bra." if "lace bra" in K_Inventory and K_Chest != "darker lace bra":
                    if K_SeenChest or ApprovalCheck("Kitty", 1300, TabM=2):
                        call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_7
                        ch_k "K."   
                ...
                "I like that kitty lingerie top." if K_Chest != "kitty lingerie top":
                    if K_SeenChest or ApprovalCheck("Kitty", 1300, TabM=2):
                        call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_8
                        ch_k "K."   
                ...
                "I like that sports bra." if K_Chest != "sports bra":
                    if K_SeenChest or ApprovalCheck("Kitty", 1000, TabM=2):
                        call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_9
                        ch_k "K."   
                        $ K_Chest = "sports bra"         
                    else:                
        ...
        "Panties": 
            ...
            menu Kitty_Clothes_Under_Panties:  
                ...
                "You could lose those panties. . ." if K_Panties and "swimsuit" not in K_Panties:
                    call KittyFace("bemused", 1) from _call_KittyFace_1491  
                    if ApprovalCheck("Kitty", 900) and (K_Legs or (K_SeenPussy and not Taboo)):
                        ...
                        if ApprovalCheck("Kitty", 1100, "LI", TabM=3) and K_Love > K_Inbt:               
                                ...
                                call KittyFace("surprised") from _call_KittyFace_1492
                                $ K_Brows = "angry"
                                if Taboo:
                                    ch_k "Not in public, [K_Petname]!"
                                else:
                    ...
                    if K_Legs:
                        ...
                        call Kitty_First_Bottomless from _call_Kitty_First_Bottomless_40
                        $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 50, 2) 
                ...
                "Why don't you wear the green panties instead?" if K_Panties and K_Panties != "green panties":
                    if ApprovalCheck("Kitty", 1100, TabM=3):
                            call Kitty_Swimsuit_Change_Bottom from _call_Kitty_Swimsuit_Change_Bottom
                            ch_k "K."
                            $ K_Panties = "green panties"  
                    else:                
                ...
                "Why don't you wear the white panties instead?" if K_Panties and K_Panties != "white panties":
                    if ApprovalCheck("Kitty", 1100, TabM=3):
                            call Kitty_Swimsuit_Change_Bottom from _call_Kitty_Swimsuit_Change_Bottom_1
                            ch_k "K."
                ...
                "Why don't you wear the lace panties instead?" if "lace panties" in K_Inventory and K_Panties and K_Panties != "lace panties":
                    if ApprovalCheck("Kitty", 1300, TabM=3):
                            call Kitty_Swimsuit_Change_Bottom from _call_Kitty_Swimsuit_Change_Bottom_2
                            ch_k "I guess."
                            $ K_Panties = "lace panties"
                    else:
                ...
                "Why don't you wear the darker lace panties instead?" if "lace panties" in K_Inventory and K_Panties and K_Panties != "darker lace panties":
                    if ApprovalCheck("Kitty", 1300, TabM=3):
                            call Kitty_Swimsuit_Change_Bottom from _call_Kitty_Swimsuit_Change_Bottom_3
                            ch_k "I guess."
                ...
                "Why don't you wear the kitty lingerie panties instead?" if K_Panties != "kitty lingerie panties":
                    if ApprovalCheck("Kitty", 1300, TabM=3):
                            call Kitty_Swimsuit_Change_Bottom from _call_Kitty_Swimsuit_Change_Bottom_4
                            ch_k "I guess."
                ...
                "You know, you could wear some panties with that. . ." if not K_Panties:
                    call KittyFace("bemused", 1) from _call_KittyFace_1493
                    if (K_Love+K_Obed) <= (2* K_Inbt):
                        ...
                        menu:
                            ...
                            "Ok":
                                jump Kitty_Clothes
                    call Kitty_Swimsuit_Change_Bottom from _call_Kitty_Swimsuit_Change_Bottom_5
                    menu:
                        ch_k "I guess. . ."
        ...
        "How about your swimsuits.":
            ...
            menu Kitty_Clothes_Under_SwimSuits:
                ...
                "Remove the swimsuit" if K_Panties == "swimsuit3" or K_Chest == "swimsuit3":
                                call Kitty_Remove_Swimsuit from _call_Kitty_Remove_Swimsuit
                                jump Kitty_Clothes_Under_SwimSuits

                "Why don't you wear the purple bikini bra?" if K_Chest != "purple bikini bra":
                    if ApprovalCheck("Kitty", 1100, TabM=3):
                            call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_10
                            ch_k "K."
                ...
                "Why don't you wear the purple bikini panties?" if K_Panties != "purple bikini panties":
                    if ApprovalCheck("Kitty", 1100, TabM=3):
                            call Kitty_Swimsuit_Change_Bottom from _call_Kitty_Swimsuit_Change_Bottom_6
                            ch_k "K."
                            $ K_Panties = "purple bikini panties"  
                    else:                
                            ch_k "I don't think that's any of your beeswax."
                ...
                "Why don't you wear the red bikini bra?" if K_Chest != "red bikini bra":
                    if ApprovalCheck("Kitty", 1100, TabM=3):
                            call Kitty_Swimsuit_Change_Top from _call_Kitty_Swimsuit_Change_Top_11
                            ch_k "K."
...
# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<  
    ...
    menu Kitty_Clothes_Misc:
        ...
        "You know, I like some nice hair down there. Maybe grow it out." if not K_Pubes and "pubes" in K_Todo:
            call KittyFace("bemused", 1) from _call_KittyFace_1494
        ...
        "You know, I like some nice hair down there. Maybe grow it out." if not K_Pubes and "pubes" not in K_Todo:
            call KittyFace("bemused", 1) from _call_KittyFace_1495
            ...
            if ApprovalCheck("Kitty", 850, "L", TabM=0) or (Approval and K_Love > 2 * K_Obed):               
                ...
                call KittyFace("surprised") from _call_KittyFace_1496
                $ K_Brows = "angry"
        ...
        "I like it waxed clean down there." if K_Pubes == 1:
            call KittyFace("bemused", 1) from _call_KittyFace_1497            
            if "shave" in K_Todo:
                ...
                if ApprovalCheck("Kitty", 850, "L", TabM=0) or (Approval and K_Love > 2 * K_Obed):               
                    ...
                    call KittyFace("surprised") from _call_KittyFace_1498
                    $ K_Brows = "angry"
                    ch_k "Not that it's any of your business, [K_Petname]."
                    jump Kitty_Clothes
                $ K_Todo.append("shave")        
        ...
        "You know, you'd look really nice with some ring body piercings." if K_Pierce != "ring" and (K_SeenPussy or K_SeenChest) and "ring" not in K_Todo:
            call KittyFace("bemused", 1) from _call_KittyFace_1499
            ...
            if ApprovalCheck("Kitty", 900, "L", TabM=0) or (Approval and K_Love > 2* K_Obed):   
                ...
                call KittyFace("surprised") from _call_KittyFace_1500
                $ K_Brows = "angry"
                ch_k "Not that it's any of your business, [K_Petname]."
                jump Kitty_Clothes            
            $ K_Todo.append("ring")
        ...
        "You know, you'd look really nice with some barbell body piercings." if K_Pierce != "barbell" and (K_SeenPussy or K_SeenChest)and "barbell" not in K_Todo:
            call KittyFace("bemused", 1) from _call_KittyFace_1501
            $ Approval = ApprovalCheck("Kitty", 1350, TabM=0)
            if ApprovalCheck("Kitty", 900, "L", TabM=0) or (Approval and K_Love > 2 * K_Obed): 
                ch_k "If you think they'd look good on me. . ."
            elif ApprovalCheck("Kitty", 600, "I", TabM=0) or (Approval and K_Inbt > K_Obed):
                ...
                call KittyFace("surprised") from _call_KittyFace_1502
                $ K_Brows = "angry"
                ch_k "Not that it's any of your business, [K_Petname]."
                jump Kitty_Clothes                
        ...
        "You know, you'd look better without those piercings." if K_Pierce:
            call KittyFace("bemused", 1) from _call_KittyFace_1503
            $ Approval = ApprovalCheck("Kitty", 1350, TabM=0)
            if ApprovalCheck("Kitty", 950, "L", TabM=0) or (Approval and K_Love > K_Obed):   
                ...
                call KittyFace("surprised") from _call_KittyFace_1504
                $ K_Brows = "angry"
...
label Kitty_Custom_Out(Custom = 3, Shame = 0, Agree = 1):
            ...
            call KittyFace("sexy", 1) from _call_KittyFace_1505
            if "exhibitionist" in K_Traits:  
            ...
            if Agree:                              
                        ...
                        if K_OutfitShame[Custom] >= 50:
                            ...
                            call KittyFace("bemused", 1) from _call_KittyFace_1506
                        ...
                        if K_OutfitShame[Custom] >= 50:
                            call KittyFace("angry", 1) from _call_KittyFace_1507
                            ch_k "You have GOT to be kidding me here."
                        elif K_OutfitShame[Custom] >= 25:
                            call KittyFace("angry", 1) from _call_KittyFace_1508
                            ch_k "This is just between us."
                        else:
                            call KittyFace("surprised", 1) from _call_KittyFace_1509
...
label Kitty_OutfitShame(Custom = 3, Check = 0, Count = 0, Tempshame = 50, Agree = 1):                                                                             #sets custom outfit    
            ...
            call KittyFace("sexy", 0) from _call_KittyFace_1510
            if Custom == 9:
                pass
            elif Count >= 20:
                $ Count = 20
                ...
                call KittyFace("startled", 1) from _call_KittyFace_1511
                ...
                call KittyFace("bemused", 1) from _call_KittyFace_1512
            ...
            if not Check:
                    ...
                    call KittyFace("angry", 1) from _call_KittyFace_1513
            ...
            if Check:
                    ...
                    call KittyFace("sexy", 0) from _call_KittyFace_1514
                    if Taboo >= 40: #K_Loc != "bg player" and K_Loc != "bg kitty": 
                        call KittyFace("confused",1) from _call_KittyFace_1515
                        $ K_Mouth = "smile"
                        ...
                        call KittyFace("smile") from _call_KittyFace_1516
                        ...
                        #if it's sleepwear      
                        call KittyFace("bemused", 1) from _call_KittyFace_1517
                        if Tempshame >= 30:
                        ...
                        call KittyFace("bemused", 1) from _call_KittyFace_1518
            ...
            if Check:
                    ...
                    #$ K_Water = 0
                    call KittyOutfit(Changed = 1) from _call_KittyOutfit_67 
                    ch_k "I wouldn't want to be seen like that."
            else:
                    ch_k "One sec, I gotta change real quick."
                    $ K_Outfit = renpy.random.choice(["pink outfit", "red outfit"])
                    $ K_Water = 0
                    call KittyOutfit(Changed = 1) from _call_KittyOutfit_68 
                    ch_k "I wouldn't want to be seen like that."
...
label Kitty_First_Les(Silent = 0, Undress = 0, GirlsNum = 0): #checked when she engages in a les scene  ## call Kitty_First_Les(0,1)
    ...
    if not Silent: 
        ...
        if "cockout" in P_RecentActions:
                call KittyFace("down", 2) from _call_KittyFace_1522  
                if GirlsNum:
        ...
        if Taboo and not ApprovalCheck("Kitty", 1500):
                call KittyFace("surprised", 2) from _call_KittyFace_1523  
                ch_k "Um, you should[K_like]put that away in public."
                call KittyFace("bemused", 1) from _call_KittyFace_1524  
                if K_SeenPeen == 1: 
                ...
                call KittyFace("sly",1) from _call_KittyFace_1525 
                if K_SeenPeen == 1: 
                    call KittyFace("surprised",2) from _call_KittyFace_1526  
                    ch_k "That's. . . impressive."
                    call KittyFace("bemused",1) from _call_KittyFace_1527  
                    $ K_Love = Statupdate("Kitty", "Love", K_Love, 90, 3) 
                elif K_SeenPeen == 2:  
                ...
                call KittyFace("sad",1) from _call_KittyFace_1528 
                if K_SeenPeen == 1: 
                    call KittyFace("perplexed",1 ) from _call_KittyFace_1529 
                    ch_k "Well that happened. . ."
                    $ K_Obed = Statupdate("Kitty", "Obed", K_Obed, 50, 7)
                    $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 3)  
                elif K_SeenPeen < 5: 
                    call KittyFace("sad",0) from _call_KittyFace_1530 
                    ch_k "Huh."
                    $ K_Inbt = Statupdate("Kitty", "Inbt", K_Inbt, 60, 2)  
                elif K_SeenPeen == 10: 
...
label Kitty_Swimsuit_Change_Top:
    ...
    if ApprovalCheck("Kitty", 900) and (K_Legs or (K_SeenPussy and not Taboo)):
        ...
        if ApprovalCheck("Kitty", 1100, "LI", TabM=3) and K_Love > K_Inbt:               
                ...
                call KittyFace("surprised") from _call_KittyFace_1531
                $ K_Brows = "angry"
                if Taboo:
                    ch_k "Not in public, [K_Petname]!"
                else:
...
label Kitty_Remove_Swimsuit:
    ...
    if ApprovalCheck("Kitty", 900) and (K_Legs or (K_SeenPussy and not Taboo)):
        ...
        if ApprovalCheck("Kitty", 1100, "LI", TabM=3) and K_Love > K_Inbt:               
                ...
                call KittyFace("surprised") from _call_KittyFace_1532
                $ K_Brows = "angry"
                if Taboo:
                    ch_k "Not in public, [K_Petname]!"
                else:
    ...
    call Kitty_Remove_Swimsuit_Top from _call_Kitty_Remove_Swimsuit_Top
    $ K_Panties = 0  
    return
